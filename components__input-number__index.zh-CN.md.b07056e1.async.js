"use strict";(self.webpackChunkantd=self.webpackChunkantd||[]).push([[6767],{13119:function(s,l,t){t.r(l);var m=t(2143),p=t(50250),_=t(59378),v=t(5648),c=t(74775),u=t(5937),Z=t(2068),b=t(74399),h=t(63942),f=t(16073),g=t(24628),x=t(19260),E=t(56140),d=t(5388),I=t(49545),A=t(6965),C=t(49706),P=t(95127),O=t(74418),D=t(73024),a=t(94065),o=t(67294),n=t(96923);function r(){var i=(0,a.eL)(),e=i.texts;return(0,n.tZ)(a.dY,null,(0,n.tZ)(o.Fragment,null,(0,n.tZ)("div",{className:"markdown"},(0,n.tZ)("p",null,e[0].value),(0,n.tZ)("h2",{id:"\u4F55\u65F6\u4F7F\u7528"},(0,n.tZ)("a",{"aria-hidden":"true",tabIndex:"-1",href:"#\u4F55\u65F6\u4F7F\u7528"},(0,n.tZ)("span",{className:"icon icon-link"})),"\u4F55\u65F6\u4F7F\u7528"),(0,n.tZ)("p",null,e[1].value),(0,n.tZ)("h2",{id:"\u4EE3\u7801\u6F14\u793A"},(0,n.tZ)("a",{"aria-hidden":"true",tabIndex:"-1",href:"#\u4EE3\u7801\u6F14\u793A"},(0,n.tZ)("span",{className:"icon icon-link"})),"\u4EE3\u7801\u6F14\u793A")),(0,n.tZ)(d.Z,{items:[{demo:{id:"components-input-number-demo-basic"},previewerProps:{title:"\u57FA\u672C",filename:"components/input-number/demo/basic.tsx",jsx:`import { InputNumber } from 'antd';
const onChange = (value) => {
  console.log('changed', value);
};
const App = () => <InputNumber min={1} max={10} defaultValue={3} onChange={onChange} />;
export default App;
`,description:"<p>\u6570\u5B57\u8F93\u5165\u6846\u3002</p>"}},{demo:{id:"components-input-number-demo-size"},previewerProps:{title:"\u4E09\u79CD\u5927\u5C0F",filename:"components/input-number/demo/size.tsx",jsx:`import { InputNumber, Space } from 'antd';
const onChange = (value) => {
  console.log('changed', value);
};
const App = () => (
...
export default App;
`,description:"<p>\u4E09\u79CD\u5927\u5C0F\u7684\u6570\u5B57\u8F93\u5165\u6846\uFF0C\u5F53 size \u5206\u522B\u4E3A <code>large</code> \u548C <code>small</code> \u65F6\uFF0C\u8F93\u5165\u6846\u9AD8\u5EA6\u4E3A <code>40px</code> \u548C <code>24px</code> \uFF0C\u9ED8\u8BA4\u9AD8\u5EA6\u4E3A <code>32px</code>\u3002</p>"}},{demo:{id:"components-input-number-demo-addon"},previewerProps:{title:"\u524D\u7F6E/\u540E\u7F6E\u6807\u7B7E",filename:"components/input-number/demo/addon.tsx",jsx:`import { SettingOutlined } from '@ant-design/icons';
...
export default App;
`,description:"<p>\u7528\u4E8E\u914D\u7F6E\u4E00\u4E9B\u56FA\u5B9A\u7EC4\u5408\u3002</p>"}},{demo:{id:"components-input-number-demo-disabled"},previewerProps:{title:"\u4E0D\u53EF\u7528",filename:"components/input-number/demo/disabled.tsx",jsx:`import { Button, InputNumber } from 'antd';
...
export default App;
`,description:"<p>\u70B9\u51FB\u6309\u94AE\u5207\u6362\u53EF\u7528\u72B6\u6001\u3002</p>"}},{demo:{id:"components-input-number-demo-digit"},previewerProps:{title:"\u9AD8\u7CBE\u5EA6\u5C0F\u6570",filename:"components/input-number/demo/digit.tsx",jsx:`import { InputNumber } from 'antd';
const onChange = (value) => {
  console.log('changed', value);
};
const App = () => (
...
export default App;
`,description:"<p>\u901A\u8FC7 <code>stringMode</code> \u5F00\u542F\u9AD8\u7CBE\u5EA6\u5C0F\u6570\u652F\u6301\uFF0C<code>onChange</code> \u4E8B\u4EF6\u5C06\u8FD4\u56DE string \u7C7B\u578B\u3002\u5BF9\u4E8E\u65E7\u7248\u6D4F\u89C8\u5668\uFF0C\u4F60\u9700\u8981 BigInt polyfill\u3002</p>"}},{demo:{id:"components-input-number-demo-formatter"},previewerProps:{title:"\u683C\u5F0F\u5316\u5C55\u793A",filename:"components/input-number/demo/formatter.tsx",jsx:`import { InputNumber, Space } from 'antd';
const onChange = (value) => {
  console.log('changed', value);
};
const App = () => (
...
</blockquote>`}},{demo:{id:"components-input-number-demo-keyboard"},previewerProps:{title:"\u952E\u76D8\u884C\u4E3A",filename:"components/input-number/demo/keyboard.tsx",jsx:`import { Checkbox, InputNumber, Space } from 'antd';
import { useState } from 'react';
const App = () => {
...
export default App;
`,description:"<p>\u4F7F\u7528 <code>keyboard</code> \u5C5E\u6027\u53EF\u4EE5\u63A7\u5236\u952E\u76D8\u884C\u4E3A\u3002</p>"}},{demo:{id:"components-input-number-demo-borderless"},previewerProps:{title:"\u65E0\u8FB9\u6846",filename:"components/input-number/demo/borderless.tsx",jsx:`import { InputNumber } from 'antd';
const App = () => <InputNumber min={1} max={10} defaultValue={3} bordered={false} />;
export default App;
`,description:"<p>\u6CA1\u6709\u8FB9\u6846\u3002</p>"}},{demo:{id:"components-input-number-demo-out-of-range"},previewerProps:{title:"\u8D85\u51FA\u8FB9\u754C",filename:"components/input-number/demo/out-of-range.tsx",jsx:`import { Button, InputNumber, Space } from 'antd';
import { useState } from 'react';
const App = () => {
...
export default App;
`,description:"<p>\u5F53\u901A\u8FC7\u53D7\u63A7\u5C06 <code>value</code> \u8D85\u51FA\u8FB9\u754C\u65F6\uFF0C\u63D0\u4F9B\u8B66\u544A\u6837\u5F0F\u3002</p>"}},{demo:{id:"components-input-number-demo-prefix"},previewerProps:{title:"\u524D\u7F00",filename:"components/input-number/demo/prefix.tsx",jsx:`import { UserOutlined } from '@ant-design/icons';
...
export default App;
`,description:"<p>\u5728\u8F93\u5165\u6846\u4E0A\u6DFB\u52A0\u524D\u7F00\u56FE\u6807\u3002</p>"}},{demo:{id:"components-input-number-demo-status"},previewerProps:{title:"\u81EA\u5B9A\u4E49\u72B6\u6001",filename:"components/input-number/demo/status.tsx",jsx:`import ClockCircleOutlined from '@ant-design/icons/ClockCircleOutlined';
...
export default App;
`,description:"<p>\u4F7F\u7528 <code>status</code> \u4E3A InputNumber \u6DFB\u52A0\u72B6\u6001\uFF0C\u53EF\u9009 <code>error</code> \u6216\u8005 <code>warning</code>\u3002</p>"}},{demo:{id:"components-input-number-demo-controls"},previewerProps:{debug:!0,title:"\u56FE\u6807\u6309\u94AE",filename:"components/input-number/demo/controls.tsx",jsx:`import { ArrowDownOutlined, ArrowUpOutlined } from '@ant-design/icons';
import { InputNumber } from 'antd';
const App = () => (
  <InputNumber
    controls={{
...
export default App;
`,description:"<p>\u53EF\u4EE5\u6269\u5C55 <code>controls</code> \u5C5E\u6027\u7528\u4EE5\u8BBE\u7F6E\u81EA\u5B9A\u4E49\u56FE\u6807\u3002</p>"}},{demo:{id:"components-input-number-demo-render-panel"},previewerProps:{debug:!0,title:"_InternalPanelDoNotUseOrYouWillBeFired",filename:"components/input-number/demo/render-panel.tsx",jsx:`import { InputNumber } from 'antd';
...
`,description:"<p>\u8C03\u8BD5\u7528\u7EC4\u4EF6\uFF0C\u8BF7\u52FF\u76F4\u63A5\u4F7F\u7528\u3002</p>"}},{demo:{id:"components-input-number-demo-debug-token"},previewerProps:{debug:!0,title:"\u8986\u76D6\u7EC4\u4EF6\u6837\u5F0F",filename:"components/input-number/demo/debug-token.tsx",jsx:`import { ConfigProvider, InputNumber, Space } from 'antd';
export default () => (
  <ConfigProvider
    theme={{
      components: {
