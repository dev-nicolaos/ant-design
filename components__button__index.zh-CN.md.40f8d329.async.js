...
export default App;
`,description:"<p>\u6309\u94AE\u6709\u4E94\u79CD\u7C7B\u578B\uFF1A\u4E3B\u6309\u94AE\u3001\u6B21\u6309\u94AE\u3001\u865A\u7EBF\u6309\u94AE\u3001\u6587\u672C\u6309\u94AE\u548C\u94FE\u63A5\u6309\u94AE\u3002\u4E3B\u6309\u94AE\u5728\u540C\u4E00\u4E2A\u64CD\u4F5C\u533A\u57DF\u6700\u591A\u51FA\u73B0\u4E00\u6B21\u3002</p>"}},{demo:{id:"components-button-demo-icon"},previewerProps:{title:"\u56FE\u6807\u6309\u94AE",filename:"components/button/demo/icon.tsx",jsx:`import { SearchOutlined } from '@ant-design/icons';
...
<p>\u5982\u679C\u60F3\u63A7\u5236 <code>Icon</code> \u5177\u4F53\u7684\u4F4D\u7F6E\uFF0C\u53EA\u80FD\u76F4\u63A5\u4F7F\u7528 <code>Icon</code> \u7EC4\u4EF6\uFF0C\u800C\u975E <code>icon</code> \u5C5E\u6027\u3002</p>`}},{demo:{id:"components-button-demo-debug-icon"},previewerProps:{debug:!0,title:"\u8C03\u8BD5\u56FE\u6807\u6309\u94AE",filename:"components/button/demo/debug-icon.tsx",jsx:`import { SearchOutlined } from '@ant-design/icons';
...
export default App;
`,description:"<p>\u8C03\u8BD5\u4F7F\u7528</p>"}},{demo:{id:"components-button-demo-debug-block"},previewerProps:{debug:!0,title:"\u8C03\u8BD5\u6309\u94AEblock\u5C5E\u6027",filename:"components/button/demo/debug-block.tsx",jsx:`import { DownloadOutlined } from '@ant-design/icons';
...
export default App;
`,description:"<p>\u8C03\u8BD5\u4F7F\u7528</p>"}},{demo:{id:"components-button-demo-size"},previewerProps:{title:"\u6309\u94AE\u5C3A\u5BF8",filename:"components/button/demo/size.tsx",jsx:`import { DownloadOutlined } from '@ant-design/icons';
...
<p>\u901A\u8FC7\u8BBE\u7F6E <code>size</code> \u4E3A <code>large</code> <code>small</code> \u5206\u522B\u628A\u6309\u94AE\u8BBE\u4E3A\u5927\u3001\u5C0F\u5C3A\u5BF8\u3002\u82E5\u4E0D\u8BBE\u7F6E <code>size</code>\uFF0C\u5219\u5C3A\u5BF8\u4E3A\u4E2D\u3002</p>`}},{demo:{id:"components-button-demo-disabled"},previewerProps:{title:"\u4E0D\u53EF\u7528\u72B6\u6001",filename:"components/button/demo/disabled.tsx",jsx:`import { Button, Space } from 'antd';
const App = () => (
  <Space direction="vertical">
    <Space>
...
export default App;
`,description:"<p>\u6DFB\u52A0 <code>disabled</code> \u5C5E\u6027\u5373\u53EF\u8BA9\u6309\u94AE\u5904\u4E8E\u4E0D\u53EF\u7528\u72B6\u6001\uFF0C\u540C\u65F6\u6309\u94AE\u6837\u5F0F\u4E5F\u4F1A\u6539\u53D8\u3002</p>"}},{demo:{id:"components-button-demo-loading"},previewerProps:{title:"\u52A0\u8F7D\u4E2D\u72B6\u6001",filename:"components/button/demo/loading.tsx",jsx:`import { PoweroffOutlined } from '@ant-design/icons';
...
export default App;
`,description:"<p>\u6DFB\u52A0 <code>loading</code> \u5C5E\u6027\u5373\u53EF\u8BA9\u6309\u94AE\u5904\u4E8E\u52A0\u8F7D\u72B6\u6001\uFF0C\u6700\u540E\u4E24\u4E2A\u6309\u94AE\u6F14\u793A\u70B9\u51FB\u540E\u8FDB\u5165\u52A0\u8F7D\u72B6\u6001\u3002</p>"}},{demo:{id:"components-button-demo-multiple"},previewerProps:{title:"\u591A\u4E2A\u6309\u94AE\u7EC4\u5408",filename:"components/button/demo/multiple.tsx",jsx:`import { Button, Dropdown, Space } from 'antd';
const onMenuClick = (e) => {
  console.log('click', e);
};
const items = [
...
export default App;
`,description:'<p>\u6309\u94AE\u7EC4\u5408\u4F7F\u7528\u65F6\uFF0C\u63A8\u8350\u4F7F\u7528 1 \u4E2A\u4E3B\u64CD\u4F5C + n \u4E2A\u6B21\u64CD\u4F5C\uFF0C3 \u4E2A\u4EE5\u4E0A\u64CD\u4F5C\u65F6\u628A\u66F4\u591A\u64CD\u4F5C\u653E\u5230 <a href="/components/dropdown/#components-dropdown-demo-dropdown-button">Dropdown.Button</a> \u4E2D\u7EC4\u5408\u4F7F\u7528\u3002</p>'}},{demo:{id:"components-button-demo-ghost"},previewerProps:{title:"\u5E7D\u7075\u6309\u94AE",filename:"components/button/demo/ghost.tsx",jsx:`import { Button, Space } from 'antd';
const App = () => (
...
export default App;
`,description:"<p>\u5E7D\u7075\u6309\u94AE\u5C06\u6309\u94AE\u7684\u5185\u5BB9\u53CD\u8272\uFF0C\u80CC\u666F\u53D8\u4E3A\u900F\u660E\uFF0C\u5E38\u7528\u5728\u6709\u8272\u80CC\u666F\u4E0A\u3002</p>"}},{demo:{id:"components-button-demo-danger"},previewerProps:{title:"\u5371\u9669\u6309\u94AE",filename:"components/button/demo/danger.tsx",jsx:`import { Button, Space } from 'antd';
const App = () => (
  <Space wrap>
...
export default App;
`,description:"<p>\u5728 4.0 \u4E4B\u540E\uFF0C\u5371\u9669\u6210\u4E3A\u4E00\u79CD\u6309\u94AE\u5C5E\u6027\u800C\u4E0D\u662F\u6309\u94AE\u7C7B\u578B\u3002</p>"}},{demo:{id:"components-button-demo-block"},previewerProps:{title:"Block \u6309\u94AE",filename:"components/button/demo/block.tsx",jsx:`import { Button, Space } from 'antd';
const App = () => (
  <Space
    direction="vertical"
    style={{
...
export default App;
`,description:"<p><code>block</code> \u5C5E\u6027\u5C06\u4F7F\u6309\u94AE\u9002\u5408\u5176\u7236\u5BBD\u5EA6\u3002</p>"}},{demo:{id:"components-button-demo-legacy-group"},previewerProps:{debug:!0,title:"\u5E9F\u5F03\u7684 Block \u7EC4",filename:"components/button/demo/legacy-group.tsx",jsx:`import { DownloadOutlined } from '@ant-design/icons';
