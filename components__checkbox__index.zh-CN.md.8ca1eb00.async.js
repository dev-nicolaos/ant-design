"use strict";(self.webpackChunkantd=self.webpackChunkantd||[]).push([[751],{37951:function(c,o,t){t.r(o);var r=t(2143),h=t(50250),p=t(59378),m=t(5648),d=t(74775),l=t(5937),v=t(2068),Z=t(74399),x=t(63942),C=t(16073),b=t(24628),k=t(19260),g=t(56140),u=t(5388),E=t(49545),P=t(6965),A=t(49706),D=t(95127),O=t(74418),f=t(73024),a=t(94065),i=t(67294),e=t(96923);function s(){var _=(0,a.eL)(),n=_.texts;return(0,e.tZ)(a.dY,null,(0,e.tZ)(i.Fragment,null,(0,e.tZ)("div",{className:"markdown"},(0,e.tZ)("p",null,n[0].value),(0,e.tZ)("h2",{id:"\u4F55\u65F6\u4F7F\u7528"},(0,e.tZ)("a",{"aria-hidden":"true",tabIndex:"-1",href:"#\u4F55\u65F6\u4F7F\u7528"},(0,e.tZ)("span",{className:"icon icon-link"})),"\u4F55\u65F6\u4F7F\u7528"),(0,e.tZ)("ul",null,(0,e.tZ)("li",null,n[1].value),(0,e.tZ)("li",null,n[2].value,(0,e.tZ)("code",null,n[3].value),n[4].value,(0,e.tZ)("code",null,n[5].value),n[6].value,(0,e.tZ)("code",null,n[7].value),n[8].value)),(0,e.tZ)("h2",{id:"\u4EE3\u7801\u6F14\u793A"},(0,e.tZ)("a",{"aria-hidden":"true",tabIndex:"-1",href:"#\u4EE3\u7801\u6F14\u793A"},(0,e.tZ)("span",{className:"icon icon-link"})),"\u4EE3\u7801\u6F14\u793A")),(0,e.tZ)(u.Z,{items:[{demo:{id:"components-checkbox-demo-basic"},previewerProps:{title:"\u57FA\u672C\u7528\u6CD5",filename:"components/checkbox/demo/basic.tsx",jsx:`import { Checkbox } from 'antd';
const onChange = (e) => {
  console.log(\`checked = \${e.target.checked}\`);
};
const App = () => <Checkbox onChange={onChange}>Checkbox</Checkbox>;
export default App;
`,description:"<p>\u7B80\u5355\u7684 checkbox\u3002</p>"}},{demo:{id:"components-checkbox-demo-disabled"},previewerProps:{title:"\u4E0D\u53EF\u7528",filename:"components/checkbox/demo/disabled.tsx",jsx:`import { Checkbox } from 'antd';
const App = () => (
  <>
...
export default App;
`,description:"<p>checkbox \u4E0D\u53EF\u7528\u3002</p>"}},{demo:{id:"components-checkbox-demo-controller"},previewerProps:{title:"\u53D7\u63A7\u7684 Checkbox",filename:"components/checkbox/demo/controller.tsx",jsx:`import { Button, Checkbox } from 'antd';
...
export default App;
`,description:"<p>\u8054\u52A8 checkbox\u3002</p>"}},{demo:{id:"components-checkbox-demo-group"},previewerProps:{title:"Checkbox \u7EC4",filename:"components/checkbox/demo/group.tsx",jsx:`import { Checkbox } from 'antd';
...
export default App;
`,description:"<p>\u65B9\u4FBF\u7684\u4ECE\u6570\u7EC4\u751F\u6210 Checkbox \u7EC4\u3002</p>"}},{demo:{id:"components-checkbox-demo-check-all"},previewerProps:{title:"\u5168\u9009",filename:"components/checkbox/demo/check-all.tsx",jsx:`import { Checkbox, Divider } from 'antd';
import { useState } from 'react';
...
export default App;
`,description:"<p>\u5728\u5B9E\u73B0\u5168\u9009\u6548\u679C\u65F6\uFF0C\u4F60\u53EF\u80FD\u4F1A\u7528\u5230 <code>indeterminate</code> \u5C5E\u6027\u3002</p>"}},{demo:{id:"components-checkbox-demo-layout"},previewerProps:{title:"\u5E03\u5C40",filename:"components/checkbox/demo/layout.tsx",jsx:`import { Checkbox, Col, Row } from 'antd';
const onChange = (checkedValues) => {
  console.log('checked = ', checkedValues);
};
const App = () => (
...
export default App;
`,description:"<p>Checkbox.Group \u5185\u5D4C Checkbox \u5E76\u4E0E Grid \u7EC4\u4EF6\u4E00\u8D77\u4F7F\u7528\uFF0C\u53EF\u4EE5\u5B9E\u73B0\u7075\u6D3B\u7684\u5E03\u5C40\u3002</p>"}},{demo:{id:"components-checkbox-demo-debug-line"},previewerProps:{debug:!0,title:"\u540C\u884C\u5E03\u5C40",filename:"components/checkbox/demo/debug-line.tsx",jsx:`import { Checkbox, Radio, Space } from 'antd';
const sharedStyle = {
...
export default App;
`,description:"<p>\u540C\u884C\u5E03\u5C40</p>"}},{demo:{id:"components-checkbox-demo-debug-disable-popover"},previewerProps:{debug:!0,title:"\u7981\u7528\u4E0B\u7684 Tooltip",filename:"components/checkbox/demo/debug-disable-popover.tsx",jsx:`import { Checkbox, Popover } from 'antd';
const App = () => (
  <div
    style={{
      padding: 56,
