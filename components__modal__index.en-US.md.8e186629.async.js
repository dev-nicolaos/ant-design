...
export default App;
`,description:"<p>Basic modal.</p>"}},{demo:{id:"components-modal-demo-async"},previewerProps:{title:"Asynchronously close",filename:"components/modal/demo/async.tsx",jsx:`import { Button, Modal } from 'antd';
import { useState } from 'react';
const App = () => {
...
export default App;
`,description:"<p>Asynchronously close a modal dialog when the OK button is pressed. For example, you can use this pattern when you submit a form.</p>"}},{demo:{id:"components-modal-demo-footer"},previewerProps:{title:"Customized Footer",filename:"components/modal/demo/footer.tsx",jsx:`import { Button, Modal } from 'antd';
import { useState } from 'react';
const App = () => {
...
<p>You could set <code>footer</code> to <code>null</code> if you don't need default footer buttons.</p>`}},{demo:{id:"components-modal-demo-confirm"},previewerProps:{title:"Confirmation modal dialog",filename:"components/modal/demo/confirm.tsx",jsx:`import { ExclamationCircleFilled } from '@ant-design/icons';
...
export default App;
`,description:"<p>Use <code>confirm()</code> to show a confirmation modal dialog. Let onCancel/onOk function return a promise object to delay closing the dialog.</p>"}},{demo:{id:"components-modal-demo-info"},previewerProps:{title:"Information modal dialog",filename:"components/modal/demo/info.tsx",jsx:`import { Button, Modal, Space } from 'antd';
const info = () => {
  Modal.info({
...
export default App;
`,description:"<p>In the various types of information modal dialog, only one button to close dialog is provided.</p>"}},{demo:{id:"components-modal-demo-locale"},previewerProps:{title:"Internationalization",filename:"components/modal/demo/locale.tsx",jsx:`import { ExclamationCircleOutlined } from '@ant-design/icons';
import { Button, Modal, Space } from 'antd';
import { useState } from 'react';
...
export default App;
`,description:"<p>To customize the text of the buttons, you need to set <code>okText</code> and <code>cancelText</code> props.</p>"}},{demo:{id:"components-modal-demo-manual"},previewerProps:{title:"Manual to update destroy",filename:"components/modal/demo/manual.tsx",jsx:`import { Button, Modal } from 'antd';
const countDown = () => {
  let secondsToGo = 5;
...
export default App;
`,description:"<p>Manually updating and destroying a modal from <code>Modal.method</code>.</p>"}},{demo:{id:"components-modal-demo-position"},previewerProps:{title:"To customize the position of modal",filename:"components/modal/demo/position.tsx",jsx:`import { Button, Modal } from 'antd';
import { useState } from 'react';
const App = () => {
...
export default App;
`,description:"<p>You can use <code>centered</code>,<code>style.top</code> or other styles to set position of modal dialog.</p>"}},{demo:{id:"components-modal-demo-confirm-router"},previewerProps:{title:"destroy confirmation modal dialog",filename:"components/modal/demo/confirm-router.tsx",jsx:`import { ExclamationCircleOutlined } from '@ant-design/icons';
...
`,description:"<p>Basic modal.</p>",style:`  [data-theme="dark"] #table-demo-summary tfoot th,
  ...
  }`}},{demo:{id:"components-modal-demo-button-props"},previewerProps:{title:"Customize footer buttons props",filename:"components/modal/demo/button-props.tsx",jsx:`import { Button, Modal } from 'antd';
import { useState } from 'react';
const App = () => {
  const [open, setOpen] = useState(false);
  const showModal = () => {
...
export default App;
`,description:"<p>Passing <code>okButtonProps</code> and <code>cancelButtonProps</code> will customize the OK button and cancel button props.</p>"}},{demo:{id:"components-modal-demo-hooks"},previewerProps:{title:"Use hooks to get context",filename:"components/modal/demo/hooks.tsx",jsx:`import { Button, Modal, Space } from 'antd';
...
export default App;
`,description:"<p>Use <code>Modal.useModal</code> to get <code>contextHolder</code> with context accessible issue.</p>"}},{demo:{id:"components-modal-demo-modal-render"},previewerProps:{title:"Custom modal content render",filename:"components/modal/demo/modal-render.tsx",jsx:`import { Button, Modal } from 'antd';
...
export default App;
`,description:"<p>Custom modal content render. use <code>react-draggable</code> implements draggable.</p>"}},{demo:{id:"components-modal-demo-width"},previewerProps:{title:"To customize the width of modal",filename:"components/modal/demo/width.tsx",jsx:`import { Button, Modal } from 'antd';
import { useState } from 'react';
const App = () => {
  const [open, setOpen] = useState(false);
  return (
...
export default App;
`,description:"<p>Use <code>width</code> to set the width of the modal dialog.</p>"}},{demo:{id:"components-modal-demo-render-panel"},previewerProps:{debug:!0,title:"_InternalPanelDoNotUseOrYouWillBeFired",filename:"components/modal/demo/render-panel.tsx",jsx:`import { Modal } from 'antd';
...
export default App;
`,description:"<p>pass <code>mousePosition</code> to control modal's animation origin position</p>"}},{demo:{id:"components-modal-demo-wireframe"},previewerProps:{debug:!0,title:"Wireframe",filename:"components/modal/demo/wireframe.tsx",jsx:`import { ConfigProvider, Modal } from 'antd';
