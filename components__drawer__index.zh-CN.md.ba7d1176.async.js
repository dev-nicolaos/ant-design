...
`,description:"<p>\u57FA\u7840\u62BD\u5C49\uFF0C\u70B9\u51FB\u89E6\u53D1\u6309\u94AE\u62BD\u5C49\u4ECE\u53F3\u6ED1\u51FA\uFF0C\u70B9\u51FB\u906E\u7F69\u533A\u5173\u95ED\u3002</p>",style:`[data-theme='compact'] .ant-drawer-body p {
  margin-bottom: 0;
}`}},{demo:{id:"components-drawer-demo-placement"},previewerProps:{title:"\u81EA\u5B9A\u4E49\u4F4D\u7F6E",filename:"components/drawer/demo/placement.tsx",jsx:`import { Button, Drawer, Radio, Space } from 'antd';
import { useState } from 'react';
const App = () => {
  const [open, setOpen] = useState(false);
...
export default App;
`,description:"<p>\u81EA\u5B9A\u4E49\u4F4D\u7F6E\uFF0C\u70B9\u51FB\u89E6\u53D1\u6309\u94AE\u62BD\u5C49\u4ECE\u76F8\u5E94\u7684\u4F4D\u7F6E\u6ED1\u51FA\uFF0C\u70B9\u51FB\u906E\u7F69\u533A\u5173\u95ED\u3002</p>"}},{demo:{id:"components-drawer-demo-extra"},previewerProps:{title:"\u989D\u5916\u64CD\u4F5C",filename:"components/drawer/demo/extra.tsx",jsx:`import { Button, Drawer, Radio, Space } from 'antd';
import { useState } from 'react';
const App = () => {
  const [open, setOpen] = useState(false);
...
export default App;
`,description:"<p>\u5728 Ant Design \u89C4\u8303\u4E2D\uFF0C\u64CD\u4F5C\u6309\u94AE\u5EFA\u8BAE\u653E\u5728\u62BD\u5C49\u7684\u53F3\u4E0A\u89D2\uFF0C\u53EF\u4EE5\u4F7F\u7528 <code>extra</code> \u5C5E\u6027\u6765\u5B9E\u73B0\u3002</p>"}},{demo:{id:"components-drawer-demo-render-in-current"},previewerProps:{title:"\u6E32\u67D3\u5728\u5F53\u524D DOM",filename:"components/drawer/demo/render-in-current.tsx",jsx:`import { Button, Drawer, theme } from 'antd';
import { useState } from 'react';
const App = () => {
...
</blockquote>`}},{demo:{id:"components-drawer-demo-form-in-drawer"},previewerProps:{title:"\u62BD\u5C49\u8868\u5355",filename:"components/drawer/demo/form-in-drawer.tsx",jsx:`import { PlusOutlined } from '@ant-design/icons';
...
}`}},{demo:{id:"components-drawer-demo-user-profile"},previewerProps:{title:"\u4FE1\u606F\u9884\u89C8\u62BD\u5C49",filename:"components/drawer/demo/user-profile.tsx",jsx:`import { Avatar, Col, Divider, Drawer, List, Row } from 'antd';
import { useState } from 'react';
...
.site-description-item-profile-p-label {
  ...
  margin-right: 8px;
  color: rgba(0, 0, 0, 0.85);
}`}},{demo:{id:"components-drawer-demo-multi-level-drawer"},previewerProps:{title:"\u591A\u5C42\u62BD\u5C49",filename:"components/drawer/demo/multi-level-drawer.tsx",jsx:`import { Button, Drawer } from 'antd';
import { useState } from 'react';
const App = () => {
  const [open, setOpen] = useState(false);
...
`,description:"<p>\u5728\u62BD\u5C49\u5185\u6253\u5F00\u65B0\u7684\u62BD\u5C49\uFF0C\u7528\u4EE5\u89E3\u51B3\u591A\u5206\u652F\u4EFB\u52A1\u7684\u590D\u6742\u72B6\u51B5\u3002</p>",style:`[data-theme="dark"] .site-multi-level-drawer-footer {
  ...
  background: #1f1f1f;
}`}},{demo:{id:"components-drawer-demo-size"},previewerProps:{title:"\u9884\u8BBE\u5BBD\u5EA6",filename:"components/drawer/demo/size.tsx",jsx:`import { Button, Drawer, Space } from 'antd';
import { useState } from 'react';
const App = () => {
  const [open, setOpen] = useState(false);
...
export default App;
`,description:"<p>\u62BD\u5C49\u7684\u9ED8\u8BA4\u5BBD\u5EA6\u4E3A <code>378px</code>\uFF0C\u53E6\u5916\u8FD8\u63D0\u4F9B\u4E00\u4E2A\u5927\u53F7\u62BD\u5C49 <code>736px</code>\uFF0C\u53EF\u4EE5\u7528 <code>size</code> \u5C5E\u6027\u6765\u8BBE\u7F6E\u3002</p>"}},{demo:{id:"components-drawer-demo-config-provider"},previewerProps:{debug:!0,title:"ConfigProvider",filename:"components/drawer/demo/config-provider.tsx",jsx:`import { Button, ConfigProvider, Drawer } from 'antd';
...
export default App;
`,description:"<p>\u652F\u6301 ConfigProvider \u914D\u7F6E\u3002</p>"}},{demo:{id:"components-drawer-demo-no-mask"},previewerProps:{debug:!0,title:"\u65E0\u906E\u7F69",filename:"components/drawer/demo/no-mask.tsx",jsx:`import { Button, Drawer } from 'antd';
import { useState } from 'react';
const App = () => {
  const [open, setOpen] = useState(false);
  const showDrawer = () => {
...
export default App;
`,description:"<p>\u901A\u8FC7 <code>mask={false}</code> \u53BB\u6389\u906E\u7F69\u3002</p>"}},{demo:{id:"components-drawer-demo-render-panel"},previewerProps:{debug:!0,title:"_InternalPanelDoNotUseOrYouWillBeFired",filename:"components/drawer/demo/render-panel.tsx",jsx:`import { Drawer } from 'antd';
...
`,description:"<p>\u8C03\u8BD5\u7528\u7EC4\u4EF6\uFF0C\u8BF7\u52FF\u76F4\u63A5\u4F7F\u7528\u3002</p>"}},{demo:{id:"components-drawer-demo-scroll-debug"},previewerProps:{debug:!0,title:"\u6EDA\u52A8\u9501\u5B9A\u8C03\u8BD5",filename:"components/drawer/demo/scroll-debug.tsx",jsx:`import { Drawer, Modal, Space, Switch } from 'antd';
import { useState } from 'react';
const App = () => {
