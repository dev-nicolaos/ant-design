"use strict";(self.webpackChunkantd=self.webpackChunkantd||[]).push([[5764],{51782:function(r,s,t){t.r(s);var m=t(2143),c=t(50250),Z=t(59378),p=t(5648),a=t(74775),u=t(5937),v=t(2068),g=t(74399),h=t(63942),x=t(16073),E=t(24628),f=t(19260),D=t(56140),o=t(5388),P=t(49545),A=t(6965),B=t(49706),C=t(95127),M=t(74418),O=t(73024),l=t(94065),d=t(67294),e=t(96923);function i(){var _=(0,l.eL)(),n=_.texts;return(0,e.tZ)(l.dY,null,(0,e.tZ)(d.Fragment,null,(0,e.tZ)("div",{className:"markdown"},(0,e.tZ)("p",null,n[0].value),(0,e.tZ)("h2",{id:"\u4F55\u65F6\u4F7F\u7528"},(0,e.tZ)("a",{"aria-hidden":"true",tabIndex:"-1",href:"#\u4F55\u65F6\u4F7F\u7528"},(0,e.tZ)("span",{className:"icon icon-link"})),"\u4F55\u65F6\u4F7F\u7528"),(0,e.tZ)("ul",null,(0,e.tZ)("li",null,n[1].value),(0,e.tZ)("li",null,n[2].value)),(0,e.tZ)("h2",{id:"\u4EE3\u7801\u6F14\u793A"},(0,e.tZ)("a",{"aria-hidden":"true",tabIndex:"-1",href:"#\u4EE3\u7801\u6F14\u793A"},(0,e.tZ)("span",{className:"icon icon-link"})),"\u4EE3\u7801\u6F14\u793A")),(0,e.tZ)(o.Z,{items:[{demo:{id:"components-message-demo-hooks"},previewerProps:{title:"Hooks \u8C03\u7528\uFF08\u63A8\u8350\uFF09",filename:"components/message/demo/hooks.tsx",jsx:`import { Button, message } from 'antd';
const App = () => {
...
export default App;
`,description:"<p>\u901A\u8FC7 <code>message.useMessage</code> \u521B\u5EFA\u652F\u6301\u8BFB\u53D6 context \u7684 <code>contextHolder</code>\u3002\u8BF7\u6CE8\u610F\uFF0C\u6211\u4EEC\u63A8\u8350\u901A\u8FC7\u9876\u5C42\u6CE8\u518C\u7684\u65B9\u5F0F\u4EE3\u66FF <code>message</code> \u9759\u6001\u65B9\u6CD5\uFF0C\u56E0\u4E3A\u9759\u6001\u65B9\u6CD5\u65E0\u6CD5\u6D88\u8D39\u4E0A\u4E0B\u6587\uFF0C\u56E0\u800C ConfigProvider \u7684\u6570\u636E\u4E5F\u4E0D\u4F1A\u751F\u6548\u3002</p>"}},{demo:{id:"components-message-demo-other"},previewerProps:{title:"\u5176\u4ED6\u63D0\u793A\u7C7B\u578B",filename:"components/message/demo/other.tsx",jsx:`import { Button, message, Space } from 'antd';
const App = () => {
  const [messageApi, contextHolder] = message.useMessage();
  const success = () => {
    messageApi.open({
...
export default App;
`,description:"<p>\u5305\u62EC\u6210\u529F\u3001\u5931\u8D25\u3001\u8B66\u544A\u3002</p>"}},{demo:{id:"components-message-demo-duration"},previewerProps:{title:"\u4FEE\u6539\u5EF6\u65F6",filename:"components/message/demo/duration.tsx",jsx:`import { Button, message } from 'antd';
const App = () => {
  const [messageApi, contextHolder] = message.useMessage();
  const success = () => {
    messageApi.open({
...
export default App;
`,description:"<p>\u81EA\u5B9A\u4E49\u65F6\u957F <code>10s</code>\uFF0C\u9ED8\u8BA4\u65F6\u957F\u4E3A <code>3s</code>\u3002</p>"}},{demo:{id:"components-message-demo-loading"},previewerProps:{title:"\u52A0\u8F7D\u4E2D",filename:"components/message/demo/loading.tsx",jsx:`import { Button, message } from 'antd';
const App = () => {
  const [messageApi, contextHolder] = message.useMessage();
  const success = () => {
    messageApi.open({
...
export default App;
`,description:"<p>\u8FDB\u884C\u5168\u5C40 loading\uFF0C\u5F02\u6B65\u81EA\u884C\u79FB\u9664\u3002</p>"}},{demo:{id:"components-message-demo-thenable"},previewerProps:{title:"Promise \u63A5\u53E3",filename:"components/message/demo/thenable.tsx",jsx:`import { Button, message } from 'antd';
const App = () => {
  const [messageApi, contextHolder] = message.useMessage();
  const success = () => {
    messageApi
...
export default App;
`,description:"<p>\u53EF\u4EE5\u901A\u8FC7 then \u63A5\u53E3\u5728\u5173\u95ED\u540E\u8FD0\u884C callback \u3002\u4EE5\u4E0A\u7528\u4F8B\u5C06\u5728\u6BCF\u4E2A message \u5C06\u8981\u7ED3\u675F\u65F6\u901A\u8FC7 then \u663E\u793A\u65B0\u7684 message \u3002</p>"}},{demo:{id:"components-message-demo-custom-style"},previewerProps:{title:"\u81EA\u5B9A\u4E49\u6837\u5F0F",filename:"components/message/demo/custom-style.tsx",jsx:`import { Button, message } from 'antd';
const App = () => {
  const [messageApi, contextHolder] = message.useMessage();
  const success = () => {
    messageApi.open({
...
export default App;
`,description:"<p>\u4F7F\u7528 <code>style</code> \u548C <code>className</code> \u6765\u5B9A\u4E49\u6837\u5F0F\u3002</p>"}},{demo:{id:"components-message-demo-update"},previewerProps:{title:"\u66F4\u65B0\u6D88\u606F\u5185\u5BB9",filename:"components/message/demo/update.tsx",jsx:`import { Button, message } from 'antd';
const App = () => {
  const [messageApi, contextHolder] = message.useMessage();
  const key = 'updatable';
  const openMessage = () => {
...
export default App;
`,description:"<p>\u53EF\u4EE5\u901A\u8FC7\u552F\u4E00\u7684 <code>key</code> \u6765\u66F4\u65B0\u5185\u5BB9\u3002</p>"}},{demo:{id:"components-message-demo-info"},previewerProps:{title:"\u666E\u901A\u63D0\u793A",filename:"components/message/demo/info.tsx",jsx:`import { Button, message } from 'antd';
const info = () => {
...
export default App;
`,description:"<p>\u4FE1\u606F\u63D0\u9192\u53CD\u9988\u3002</p>"}},{demo:{id:"components-message-demo-render-panel"},previewerProps:{debug:!0,title:"_InternalPanelDoNotUseOrYouWillBeFired",filename:"components/message/demo/render-panel.tsx",jsx:`import { message } from 'antd';
