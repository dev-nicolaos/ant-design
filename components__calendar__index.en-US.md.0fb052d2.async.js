"use strict";(self.webpackChunkantd=self.webpackChunkantd||[]).push([[3880],{20761:function(_,a,t){t.r(a);var c=t(2143),m=t(50250),h=t(59378),v=t(5648),o=t(74775),d=t(5937),p=t(2068),Z=t(74399),g=t(63942),C=t(16073),D=t(24628),P=t(19260),E=t(56140),s=t(5388),f=t(49545),y=t(6965),x=t(49706),w=t(95127),M=t(74418),O=t(73024),l=t(94065),u=t(67294),n=t(96923);function r(){var i=(0,l.eL)(),e=i.texts;return(0,n.tZ)(l.dY,null,(0,n.tZ)(u.Fragment,null,(0,n.tZ)("div",{className:"markdown"},(0,n.tZ)("p",null,e[0].value),(0,n.tZ)("h2",{id:"when-to-use"},(0,n.tZ)("a",{"aria-hidden":"true",tabIndex:"-1",href:"#when-to-use"},(0,n.tZ)("span",{className:"icon icon-link"})),"When To Use"),(0,n.tZ)("p",null,e[1].value),(0,n.tZ)("h2",{id:"examples"},(0,n.tZ)("a",{"aria-hidden":"true",tabIndex:"-1",href:"#examples"},(0,n.tZ)("span",{className:"icon icon-link"})),"Examples")),(0,n.tZ)(s.Z,{items:[{demo:{id:"components-calendar-demo-basic"},previewerProps:{title:"Basic",filename:"components/calendar/demo/basic.tsx",jsx:`import { Calendar } from 'antd';
const App = () => {
...
export default App;
`,description:"<p>A basic calendar component with Year/Month switch.</p>"}},{demo:{id:"components-calendar-demo-notice-calendar"},previewerProps:{title:"Notice Calendar",filename:"components/calendar/demo/notice-calendar.tsx",jsx:`import { Badge, Calendar } from 'antd';
...
.notes-month section {
  font-size: 28px;
}`}},{demo:{id:"components-calendar-demo-card"},previewerProps:{title:"Card",filename:"components/calendar/demo/card.tsx",jsx:`import { Calendar, theme } from 'antd';
const App = () => {
...
export default App;
`,description:"<p>Nested inside a container element for rendering in limited space.</p>"}},{demo:{id:"components-calendar-demo-select"},previewerProps:{title:"Selectable Calendar",filename:"components/calendar/demo/select.tsx",jsx:`import { Alert, Calendar } from 'antd';
...
export default App;
`,description:"<p>A basic calendar component with Year/Month switch.</p>"}},{demo:{id:"components-calendar-demo-customize-header"},previewerProps:{title:"Customize Header",filename:"components/calendar/demo/customize-header.tsx",jsx:`import { Calendar, Col, Radio, Row, Select, theme, Typography } from 'antd';
import dayjs from 'dayjs';
