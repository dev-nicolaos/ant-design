...
export default App;
`,description:"<p>\u57FA\u672C\u6807\u7B7E\u7684\u7528\u6CD5\uFF0C\u53EF\u4EE5\u901A\u8FC7\u6DFB\u52A0 <code>closable</code> \u53D8\u4E3A\u53EF\u5173\u95ED\u6807\u7B7E\u3002\u53EF\u5173\u95ED\u6807\u7B7E\u5177\u6709 <code>onClose</code> \u4E8B\u4EF6\u3002</p>"}},{demo:{id:"components-tag-demo-colorful"},previewerProps:{title:"\u591A\u5F69\u6807\u7B7E",filename:"components/tag/demo/colorful.tsx",jsx:`import { Divider, Tag } from 'antd';
const App = () => (
  <>
...
`,description:"<p>\u6211\u4EEC\u6DFB\u52A0\u4E86\u591A\u79CD\u9884\u8BBE\u8272\u5F69\u7684\u6807\u7B7E\u6837\u5F0F\uFF0C\u7528\u4F5C\u4E0D\u540C\u573A\u666F\u4F7F\u7528\u3002\u5982\u679C\u9884\u8BBE\u503C\u4E0D\u80FD\u6EE1\u8DB3\u4F60\u7684\u9700\u6C42\uFF0C\u53EF\u4EE5\u8BBE\u7F6E\u4E3A\u5177\u4F53\u7684\u8272\u503C\u3002</p>",style:`.code-box-demo .ant-tag {
  margin-bottom: 8px;
}`}},{demo:{id:"components-tag-demo-colorful-inverse"},previewerProps:{debug:!0,title:"\u53CD\u8272\u591A\u5F69\u6807\u7B7E",filename:"components/tag/demo/colorful-inverse.tsx",jsx:`import { Divider, Tag } from 'antd';
const App = () => (
  <>
...
`,description:"<p>\u5185\u90E8\u53CD\u8272\u6807\u7B7E</p>",style:`.code-box-demo .ant-tag {
  margin-bottom: 8px;
}`}},{demo:{id:"components-tag-demo-control"},previewerProps:{title:"\u52A8\u6001\u6DFB\u52A0\u548C\u5220\u9664",filename:"components/tag/demo/control.tsx",jsx:`import { PlusOutlined } from '@ant-design/icons';
...
export default App;
`,description:"<p>\u7528\u6570\u7EC4\u751F\u6210\u4E00\u7EC4\u6807\u7B7E\uFF0C\u53EF\u4EE5\u52A8\u6001\u6DFB\u52A0\u548C\u5220\u9664\u3002</p>"}},{demo:{id:"components-tag-demo-checkable"},previewerProps:{title:"\u53EF\u9009\u62E9\u6807\u7B7E",filename:"components/tag/demo/checkable.tsx",jsx:`import { Tag } from 'antd';
...
</blockquote>`}},{demo:{id:"components-tag-demo-animation"},previewerProps:{title:"\u6DFB\u52A0\u52A8\u753B",filename:"components/tag/demo/animation.tsx",jsx:`import { PlusOutlined } from '@ant-design/icons';
...
export default App;
`,description:'<p>\u4F7F\u7528 <a href="https://github.com/react-component/tween-one">rc-tween-one</a> \u7ED9\u6807\u7B7E\u589E\u52A0\u6DFB\u52A0\u6216\u5220\u9664\u52A8\u753B\u3002</p>'}},{demo:{id:"components-tag-demo-icon"},previewerProps:{title:"\u56FE\u6807\u6309\u94AE",filename:"components/tag/demo/icon.tsx",jsx:`import {
  FacebookOutlined,
  LinkedinOutlined,
  TwitterOutlined,
  YoutubeOutlined,
...
<p>\u5982\u679C\u60F3\u63A7\u5236 <code>Icon</code> \u5177\u4F53\u7684\u4F4D\u7F6E\uFF0C\u53EA\u80FD\u76F4\u63A5\u4F7F\u7528 <code>Icon</code> \u7EC4\u4EF6\uFF0C\u800C\u975E <code>icon</code> \u5C5E\u6027\u3002</p>`}},{demo:{id:"components-tag-demo-status"},previewerProps:{title:"\u9884\u8BBE\u72B6\u6001\u7684\u6807\u7B7E",filename:"components/tag/demo/status.tsx",jsx:`import {
  CheckCircleOutlined,
  ClockCircleOutlined,
  CloseCircleOutlined,
...
export default App;
`,description:"<p>\u9884\u8BBE\u4E94\u79CD\u72B6\u6001\u989C\u8272\uFF0C\u53EF\u4EE5\u901A\u8FC7\u8BBE\u7F6E <code>color</code> \u4E3A <code>success</code>\u3001 <code>processing</code>\u3001<code>error</code>\u3001<code>default</code>\u3001<code>warning</code> \u6765\u4EE3\u8868\u4E0D\u540C\u7684\u72B6\u6001\u3002</p>"}},{demo:{id:"components-tag-demo-customize"},previewerProps:{debug:!0,title:"\u81EA\u5B9A\u4E49\u5173\u95ED\u6309\u94AE",filename:"components/tag/demo/customize.tsx",jsx:`import { CloseCircleOutlined } from '@ant-design/icons';
import { Tag } from 'antd';
const App = () => (
  <>
