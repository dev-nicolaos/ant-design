...
export default App;
`,description:"<p>Skeleton Button, Avatar, Input, Image and Node.</p>"}},{demo:{id:"components-skeleton-demo-children"},previewerProps:{title:"Contains sub component",filename:"components/skeleton/demo/children.tsx",jsx:`import { Button, Skeleton } from 'antd';
import { useState } from 'react';
const App = () => {
