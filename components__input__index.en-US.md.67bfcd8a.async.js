"use strict";(self.webpackChunkantd=self.webpackChunkantd||[]).push([[158],{7278:function(s,a,e){e.r(a);var c=e(2143),h=e(50250),m=e(59378),v=e(5648),o=e(74775),l=e(5937),Z=e(2068),_=e(74399),f=e(63942),g=e(16073),x=e(24628),I=e(19260),b=e(56140),i=e(5388),w=e(49545),S=e(6965),O=e(49706),y=e(95127),A=e(74418),C=e(73024),u=e(94065),r=e(67294),n=e(96923);function d(){var p=(0,u.eL)(),t=p.texts;return(0,n.tZ)(u.dY,null,(0,n.tZ)(r.Fragment,null,(0,n.tZ)("div",{className:"markdown"},(0,n.tZ)("p",null,t[0].value),(0,n.tZ)("h2",{id:"when-to-use"},(0,n.tZ)("a",{"aria-hidden":"true",tabIndex:"-1",href:"#when-to-use"},(0,n.tZ)("span",{className:"icon icon-link"})),"When To Use"),(0,n.tZ)("ul",null,(0,n.tZ)("li",null,t[1].value),(0,n.tZ)("li",null,t[2].value)),(0,n.tZ)("h2",{id:"examples"},(0,n.tZ)("a",{"aria-hidden":"true",tabIndex:"-1",href:"#examples"},(0,n.tZ)("span",{className:"icon icon-link"})),"Examples")),(0,n.tZ)(i.Z,{items:[{demo:{id:"components-input-demo-basic"},previewerProps:{title:"Basic usage",filename:"components/input/demo/basic.tsx",jsx:`import { Input } from 'antd';
const App = () => <Input placeholder="Basic usage" />;
export default App;
`,description:"<p>Basic usage example.</p>"}},{demo:{id:"components-input-demo-size"},previewerProps:{title:"Three sizes of Input",filename:"components/input/demo/size.tsx",jsx:`import { UserOutlined } from '@ant-design/icons';
...
export default App;
`,description:"<p>There are three sizes of an Input box: <code>large</code> (40px), <code>default</code> (32px) and <code>small</code> (24px).</p>"}},{demo:{id:"components-input-demo-addon"},previewerProps:{title:"Pre / Post tab",filename:"components/input/demo/addon.tsx",jsx:`import { SettingOutlined } from '@ant-design/icons';
...
export default App;
`,description:"<p>Using pre &#x26; post tabs example.</p>"}},{demo:{id:"components-input-demo-group"},previewerProps:{title:"Input Group",filename:"components/input/demo/group.tsx",jsx:`import { CopyOutlined } from '@ant-design/icons';
import {
  AutoComplete,
  Button,
  Cascader,
...
}`}},{demo:{id:"components-input-demo-search-input"},previewerProps:{title:"Search box",filename:"components/input/demo/search-input.tsx",jsx:`import { AudioOutlined } from '@ant-design/icons';
...
export default App;
`,description:"<p>Example of creating a search box by grouping a standard input with a search button.</p>"}},{demo:{id:"components-input-demo-search-input-loading"},previewerProps:{title:"Search box with loading",filename:"components/input/demo/search-input-loading.tsx",jsx:`import { Input } from 'antd';
const { Search } = Input;
const App = () => (
  <>
...
export default App;
`,description:"<p>Search loading when onSearch.</p>"}},{demo:{id:"components-input-demo-textarea"},previewerProps:{title:"TextArea",filename:"components/input/demo/textarea.tsx",jsx:`import { Input } from 'antd';
...
export default App;
`,description:"<p>For multi-line input.</p>"}},{demo:{id:"components-input-demo-autosize-textarea"},previewerProps:{title:"Autosizing the height to fit the content",filename:"components/input/demo/autosize-textarea.tsx",jsx:`import { Input } from 'antd';
...
.numeric-input .numeric-input-title {
  font-size: 14px;
}`}},{demo:{id:"components-input-demo-presuffix"},previewerProps:{title:"prefix and suffix",filename:"components/input/demo/presuffix.tsx",jsx:`import { InfoCircleOutlined, UserOutlined } from '@ant-design/icons';
...
export default App;
`,description:"<p>Add a prefix or suffix icons inside input.</p>"}},{demo:{id:"components-input-demo-password-input"},previewerProps:{title:"Password box",filename:"components/input/demo/password-input.tsx",jsx:`import { EyeTwoTone } from '@ant-design/icons';
...
export default App;
`,description:"<p>Input type of password.</p>"}},{demo:{id:"components-input-demo-allowclear"},previewerProps:{title:"With clear icon",filename:"components/input/demo/allowClear.tsx",jsx:`import { Input } from 'antd';
const { TextArea } = Input;
const onChange = (e) => {
  console.log(e);
};
...
export default App;
`,description:"<p>Input box with the remove icon, click the icon to delete everything.</p>"}},{demo:{id:"components-input-demo-show-count"},previewerProps:{title:"With character counting",filename:"components/input/demo/show-count.tsx",jsx:`import { Input } from 'antd';
const { TextArea } = Input;
const onChange = (e) => {
...
export default App;
`,description:"<p>Show character counting.</p>"}},{demo:{id:"components-input-demo-textarea-show-count"},previewerProps:{title:"Textarea with character counting",filename:"components/input/demo/textarea-show-count.tsx",jsx:`import { Input } from 'antd';
const { TextArea } = Input;
const onChange = (e) => {
  console.log('Change:', e.target.value);
};
...
export default App;
`,description:"<p>Show character counting.</p>"}},{demo:{id:"components-input-demo-status"},previewerProps:{title:"Status",filename:"components/input/demo/status.tsx",jsx:`import ClockCircleOutlined from '@ant-design/icons/ClockCircleOutlined';
import { Input, Space } from 'antd';
const App = () => (
  <Space
    direction="vertical"
...
export default App;
`,description:"<p>Add status to Input with <code>status</code>, which could be <code>error</code> or <code>warning</code>.</p>"}},{demo:{id:"components-input-demo-borderless"},previewerProps:{title:"Borderless",filename:"components/input/demo/borderless.tsx",jsx:`import { Input } from 'antd';
const App = () => <Input placeholder="Borderless" bordered={false} />;
export default App;
`,description:"<p>No border.</p>"}},{demo:{id:"components-input-demo-focus"},previewerProps:{title:"Focus",filename:"components/input/demo/focus.tsx",jsx:`import { Button, Input, Space, Switch } from 'antd';
...
export default App;
`,description:"<p>Focus with additional option.</p>"}},{demo:{id:"components-input-demo-borderless-debug"},previewerProps:{debug:!0,title:"Style Debug",filename:"components/input/demo/borderless-debug.tsx",jsx:`import { Input } from 'antd';
const { TextArea } = Input;
const App = () => (
  <div
    style={{
...
export default App;
`,description:"<p>Buggy!</p>"}},{demo:{id:"components-input-demo-align"},previewerProps:{debug:!0,title:"Text Align",filename:"components/input/demo/align.tsx",jsx:`import {
  AutoComplete,
  Button,
  Cascader,
  DatePicker,
...
export default App;
`}},{demo:{id:"components-input-demo-textarea-resize"},previewerProps:{debug:!0,title:"TextArea",filename:"components/input/demo/textarea-resize.tsx",jsx:`import { Button, Input } from 'antd';
import { useState } from 'react';
const { TextArea } = Input;
const defaultValue =
...
export default App;
`,description:"<p>For multi-line input.</p>"}},{demo:{id:"components-input-demo-debug-addon"},previewerProps:{debug:!0,title:"debug Pre / Post tab",filename:"components/input/demo/debug-addon.tsx",jsx:`import { SettingOutlined } from '@ant-design/icons';
import { Button, Input, Space } from 'antd';
const App = () => (
  <Space direction="vertical">
    Input addon Button:
