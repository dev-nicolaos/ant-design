"use strict";(self.webpackChunkantd=self.webpackChunkantd||[]).push([[2600],{57114:function(r,a,t){t.r(a);var g=t(2143),c=t(50250),_=t(59378),p=t(5648),m=t(74775),o=t(5937),T=t(2068),h=t(74399),f=t(63942),v=t(16073),I=t(24628),C=t(19260),E=t(56140),i=t(5388),x=t(49545),b=t(6965),Z=t(49706),O=t(95127),P=t(74418),D=t(73024),l=t(94065),s=t(67294),n=t(96923);function d(){var u=(0,l.eL)(),e=u.texts;return(0,n.tZ)(l.dY,null,(0,n.tZ)(s.Fragment,null,(0,n.tZ)("div",{className:"markdown"},(0,n.tZ)("p",null,e[0].value),(0,n.tZ)("h2",{id:"when-to-use"},(0,n.tZ)("a",{"aria-hidden":"true",tabIndex:"-1",href:"#when-to-use"},(0,n.tZ)("span",{className:"icon icon-link"})),"When To Use"),(0,n.tZ)("ul",null,(0,n.tZ)("li",null,(0,n.tZ)("p",null,e[1].value)),(0,n.tZ)("li",null,(0,n.tZ)("p",null,e[2].value))),(0,n.tZ)("h2",{id:"examples"},(0,n.tZ)("a",{"aria-hidden":"true",tabIndex:"-1",href:"#examples"},(0,n.tZ)("span",{className:"icon icon-link"})),"Examples")),(0,n.tZ)(i.Z,{items:[{demo:{id:"components-tag-demo-basic"},previewerProps:{title:"Basic",filename:"components/tag/demo/basic.tsx",jsx:`import { Tag } from 'antd';
const log = (e) => {
  console.log(e);
};
...
export default App;
`,description:"<p>Usage of basic Tag, and it could be closable by set <code>closable</code> property. Closable Tag supports <code>onClose</code> events.</p>"}},{demo:{id:"components-tag-demo-colorful"},previewerProps:{title:"Colorful Tag",filename:"components/tag/demo/colorful.tsx",jsx:`import { Divider, Tag } from 'antd';
const App = () => (
  <>
...
`,description:"<p>We preset a series of colorful tag styles for use in different situations. You can also set it to a hex color string for custom color.</p>",style:`.code-box-demo .ant-tag {
  margin-bottom: 8px;
}`}},{demo:{id:"components-tag-demo-colorful-inverse"},previewerProps:{debug:!0,title:"Inverse Colorful Tag",filename:"components/tag/demo/colorful-inverse.tsx",jsx:`import { Divider, Tag } from 'antd';
const App = () => (
  <>
...
`,description:"<p>Internal inverse color tag</p>",style:`.code-box-demo .ant-tag {
  margin-bottom: 8px;
}`}},{demo:{id:"components-tag-demo-control"},previewerProps:{title:"Add & Remove Dynamically",filename:"components/tag/demo/control.tsx",jsx:`import { PlusOutlined } from '@ant-design/icons';
...
export default App;
`,description:"<p>Generating a set of Tags by array, you can add and remove dynamically.</p>"}},{demo:{id:"components-tag-demo-checkable"},previewerProps:{title:"Checkable",filename:"components/tag/demo/checkable.tsx",jsx:`import { Tag } from 'antd';
