"use strict";(self.webpackChunkantd=self.webpackChunkantd||[]).push([[6552],{43951:function(r,o,l){l.r(o);var p=l(2143),v=l(50250),Z=l(59378),m=l(5648),u=l(74775),t=l(5937),h=l(2068),_=l(74399),g=l(63942),f=l(16073),b=l(24628),S=l(19260),x=l(56140),d=l(5388),C=l(49545),y=l(6965),A=l(49706),E=l(95127),w=l(74418),D=l(73024),a=l(94065),s=l(67294),n=l(96923);function i(){var c=(0,a.eL)(),e=c.texts;return(0,n.tZ)(a.dY,null,(0,n.tZ)(s.Fragment,null,(0,n.tZ)("div",{className:"markdown"},(0,n.tZ)("p",null,e[0].value),(0,n.tZ)("h2",{id:"\u4F55\u65F6\u4F7F\u7528"},(0,n.tZ)("a",{"aria-hidden":"true",tabIndex:"-1",href:"#\u4F55\u65F6\u4F7F\u7528"},(0,n.tZ)("span",{className:"icon icon-link"})),"\u4F55\u65F6\u4F7F\u7528"),(0,n.tZ)("ul",null,(0,n.tZ)("li",null,e[1].value),(0,n.tZ)("li",null,e[2].value,(0,n.tZ)(a.rU,{to:"/components/radio-cn/"},e[3].value),e[4].value)),(0,n.tZ)("h2",{id:"\u4EE3\u7801\u6F14\u793A"},(0,n.tZ)("a",{"aria-hidden":"true",tabIndex:"-1",href:"#\u4EE3\u7801\u6F14\u793A"},(0,n.tZ)("span",{className:"icon icon-link"})),"\u4EE3\u7801\u6F14\u793A")),(0,n.tZ)(d.Z,{items:[{demo:{id:"components-select-demo-basic"},previewerProps:{title:"\u57FA\u672C\u4F7F\u7528",filename:"components/select/demo/basic.tsx",jsx:`import { Select } from 'antd';
...
export default App;
`,description:"<p>\u57FA\u672C\u4F7F\u7528\u3002</p>"}},{demo:{id:"components-select-demo-search"},previewerProps:{title:"\u5E26\u641C\u7D22\u6846",filename:"components/select/demo/search.tsx",jsx:`import { Select } from 'antd';
...
export default App;
`,description:"<p>\u5C55\u5F00\u540E\u53EF\u5BF9\u9009\u9879\u8FDB\u884C\u641C\u7D22\u3002</p>"}},{demo:{id:"components-select-demo-multiple"},previewerProps:{title:"\u591A\u9009",filename:"components/select/demo/multiple.tsx",jsx:`import { Select } from 'antd';
const options = [];
for (let i = 10; i < 36; i++) {
  options.push({
...
export default App;
`,description:"<p>\u591A\u9009\uFF0C\u4ECE\u5DF2\u6709\u6761\u76EE\u4E2D\u9009\u62E9\u3002</p>"}},{demo:{id:"components-select-demo-size"},previewerProps:{title:"\u4E09\u79CD\u5927\u5C0F",filename:"components/select/demo/size.tsx",jsx:`import { Radio, Select } from 'antd';
...
#components-select-demo-search-box .code-box-demo .ant-select {
  margin: 0;
}`}},{demo:{id:"components-select-demo-option-label-prop"},previewerProps:{title:"\u5B9A\u5236\u56DE\u586B\u5185\u5BB9",filename:"components/select/demo/option-label-prop.tsx",jsx:`import { Select } from 'antd';
const { Option } = Select;
const handleChange = (value) => {
  console.log(\`selected \${value}\`);
};
...
`,description:"<p>\u4F7F\u7528 <code>optionLabelProp</code> \u6307\u5B9A\u56DE\u586B\u5230\u9009\u62E9\u6846\u7684 <code>Option</code> \u5C5E\u6027\u3002</p>",style:`.demo-option-label-item > span {
  margin-right: 6px;
}`}},{demo:{id:"components-select-demo-search-sort"},previewerProps:{title:"\u5E26\u6392\u5E8F\u7684\u641C\u7D22",filename:"components/select/demo/search-sort.tsx",jsx:`import { Select } from 'antd';
const App = () => (
  <Select
    showSearch
    style={{
...
export default App;
`,description:"<p>\u5728\u641C\u7D22\u6A21\u5F0F\u4E0B\u5BF9\u8FC7\u6EE4\u7ED3\u679C\u9879\u8FDB\u884C\u6392\u5E8F\u3002</p>"}},{demo:{id:"components-select-demo-tags"},previewerProps:{title:"\u6807\u7B7E",filename:"components/select/demo/tags.tsx",jsx:`import { Select } from 'antd';
const options = [];
for (let i = 10; i < 36; i++) {
  options.push({
    value: i.toString(36) + i,
...
export default App;
`,description:"<p>tags select\uFF0C\u968F\u610F\u8F93\u5165\u7684\u5185\u5BB9\uFF08scroll the menu\uFF09\u3002</p>"}},{demo:{id:"components-select-demo-optgroup"},previewerProps:{title:"\u5206\u7EC4",filename:"components/select/demo/optgroup.tsx",jsx:`import { Select } from 'antd';
const handleChange = (value) => {
  console.log(\`selected \${value}\`);
};
const App = () => (
...
export default App;
`,description:"<p>\u7528 <code>OptGroup</code> \u8FDB\u884C\u9009\u9879\u5206\u7EC4\u3002</p>"}},{demo:{id:"components-select-demo-coordinate"},previewerProps:{title:"\u8054\u52A8",filename:"components/select/demo/coordinate.tsx",jsx:`import { Select } from 'antd';
import { useState } from 'react';
...
<p>\u63A8\u8350\u4F7F\u7528 <a href="/components/cascader/">Cascader</a> \u7EC4\u4EF6\u3002</p>`}},{demo:{id:"components-select-demo-search-box"},previewerProps:{title:"\u641C\u7D22\u6846",filename:"components/select/demo/search-box.tsx",jsx:`import { Select } from 'antd';
...
export default App;
`,description:"<p>\u641C\u7D22\u548C\u8FDC\u7A0B\u6570\u636E\u7ED3\u5408\u3002</p>"}},{demo:{id:"components-select-demo-label-in-value"},previewerProps:{title:"\u83B7\u5F97\u9009\u9879\u7684\u6587\u672C",filename:"components/select/demo/label-in-value.tsx",jsx:`import { Select } from 'antd';
const handleChange = (value) => {
...
<p>\u9009\u4E2D\u9879\u7684 <code>label</code> \u4F1A\u88AB\u5305\u88C5\u5230 <code>value</code> \u4E2D\u4F20\u9012\u7ED9 <code>onChange</code> \u7B49\u51FD\u6570\uFF0C\u6B64\u65F6 <code>value</code> \u662F\u4E00\u4E2A\u5BF9\u8C61\u3002</p>`}},{demo:{id:"components-select-demo-automatic-tokenization"},previewerProps:{title:"\u81EA\u52A8\u5206\u8BCD",filename:"components/select/demo/automatic-tokenization.tsx",jsx:`import { Select } from 'antd';
const options = [];
for (let i = 10; i < 36; i++) {
  options.push({
    value: i.toString(36) + i,
...
export default App;
`,description:"<p>\u8BD5\u4E0B\u590D\u5236 <code>\u9732\u897F,\u6770\u514B</code> \u5E76\u7C98\u8D34\u5230\u8F93\u5165\u6846\u91CC\u3002\u53EA\u5728 tags \u548C multiple \u6A21\u5F0F\u4E0B\u53EF\u7528\u3002</p>"}},{demo:{id:"components-select-demo-select-users"},previewerProps:{title:"\u641C\u7D22\u7528\u6237",filename:"components/select/demo/select-users.tsx",jsx:`import { Select } from 'antd';
...
export default App;
`,description:"<p>\u4E00\u4E2A\u5E26\u6709\u8FDC\u7A0B\u641C\u7D22\uFF0C\u9632\u6296\u63A7\u5236\uFF0C\u8BF7\u6C42\u65F6\u5E8F\u63A7\u5236\uFF0C\u52A0\u8F7D\u72B6\u6001\u7684\u591A\u9009\u793A\u4F8B\u3002</p>"}},{demo:{id:"components-select-demo-suffix"},previewerProps:{debug:!0,title:"\u540E\u7F00\u56FE\u6807",filename:"components/select/demo/suffix.tsx",jsx:`import { MehOutlined, SmileOutlined } from '@ant-design/icons';
...
export default App;
`,description:"<p>\u57FA\u672C\u4F7F\u7528\u3002</p>"}},{demo:{id:"components-select-demo-custom-dropdown-menu"},previewerProps:{title:"\u6269\u5C55\u83DC\u5355",filename:"components/select/demo/custom-dropdown-menu.tsx",jsx:`import { PlusOutlined } from '@ant-design/icons';
...
export default App;
`,description:'<p>\u4F7F\u7528 <code>dropdownRender</code> \u5BF9\u4E0B\u62C9\u83DC\u5355\u8FDB\u884C\u81EA\u7531\u6269\u5C55\u3002\u5982\u679C\u5E0C\u671B\u70B9\u51FB\u81EA\u5B9A\u4E49\u5185\u5BB9\u540E\u5173\u95ED\u6D6E\u5C42\uFF0C\u4F60\u9700\u8981\u4F7F\u7528\u53D7\u63A7\u6A21\u5F0F\u81EA\u884C\u63A7\u5236\uFF08<a href="https://codesandbox.io/s/ji-ben-shi-yong-antd-4-21-7-forked-gnp4cy?file=/demo.js">codesandbox</a>\uFF09\u3002</p>'}},{demo:{id:"components-select-demo-hide-selected"},previewerProps:{title:"\u9690\u85CF\u5DF2\u9009\u62E9\u9009\u9879",filename:"components/select/demo/hide-selected.tsx",jsx:`import { Select } from 'antd';
import { useState } from 'react';
...
export default App;
`,description:"<p>\u9690\u85CF\u4E0B\u62C9\u5217\u8868\u4E2D\u5DF2\u9009\u62E9\u7684\u9009\u9879\u3002</p>"}},{demo:{id:"components-select-demo-bordered"},previewerProps:{title:"\u65E0\u8FB9\u6846",filename:"components/select/demo/bordered.tsx",jsx:`import { Select } from 'antd';
const App = () => (
  <>
    <Select
      defaultValue="lucy"
...
export default App;
`,description:"<p>\u65E0\u8FB9\u6846\u6837\u5F0F\u3002</p>"}},{demo:{id:"components-select-demo-custom-tag-render"},previewerProps:{title:"\u81EA\u5B9A\u4E49\u9009\u62E9\u6807\u7B7E",filename:"components/select/demo/custom-tag-render.tsx",jsx:`import { Select, Tag } from 'antd';
const options = [
  {
    value: 'gold',
  },
...
export default App;
`,description:"<p>\u5141\u8BB8\u81EA\u5B9A\u4E49\u9009\u62E9\u6807\u7B7E\u7684\u6837\u5F0F\u3002</p>"}},{demo:{id:"components-select-demo-responsive"},previewerProps:{title:"\u54CD\u5E94\u5F0F maxTagCount",filename:"components/select/demo/responsive.tsx",jsx:`import { Select, Space } from 'antd';
import { useState } from 'react';
const options = [];
for (let i = 10; i < 36; i++) {
...
export default App;
`,description:"<p>\u591A\u9009\u4E0B\u901A\u8FC7\u54CD\u5E94\u5F0F\u5E03\u5C40\u8BA9\u9009\u9879\u81EA\u52A8\u6536\u7F29\u3002\u8BE5\u529F\u80FD\u5BF9\u6027\u80FD\u6709\u6240\u6D88\u8017\uFF0C\u4E0D\u63A8\u8350\u5728\u5927\u8868\u5355\u573A\u666F\u4E0B\u4F7F\u7528\u3002</p>"}},{demo:{id:"components-select-demo-big-data"},previewerProps:{title:"\u5927\u6570\u636E",filename:"components/select/demo/big-data.tsx",jsx:`import { Divider, Select, Typography } from 'antd';
...
`,description:"<p>\u4F7F\u7528 <code>status</code> \u4E3A Select \u6DFB\u52A0\u72B6\u6001\uFF0C\u53EF\u9009 <code>error</code> \u6216\u8005 <code>warning</code>\u3002</p>",style:`#components-select-demo-status .ant-select {
  margin: 0;
}`}},{demo:{id:"components-select-demo-placement"},previewerProps:{title:"\u5F39\u51FA\u4F4D\u7F6E",filename:"components/select/demo/placement.tsx",jsx:`import { Radio, Select } from 'antd';
import { useState } from 'react';
const App = () => {
...
export default App;
`,description:"<p>\u53EF\u4EE5\u901A\u8FC7 <code>placement</code> \u624B\u52A8\u6307\u5B9A\u5F39\u51FA\u7684\u4F4D\u7F6E\u3002</p>"}},{demo:{id:"components-select-demo-debug"},previewerProps:{debug:!0,title:"4.0 Debug",filename:"components/select/demo/debug.tsx",jsx:`import { Button, Input, Select } from 'antd';
const handleChange = (value) => {
  console.log(\`selected \${value}\`);
};
const App = () => (
