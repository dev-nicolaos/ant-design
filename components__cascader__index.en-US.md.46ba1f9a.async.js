"use strict";(self.webpackChunkantd=self.webpackChunkantd||[]).push([[3891],{11570:function(c,o,l){l.r(o);var p=l(2143),v=l(50250),h=l(59378),Z=l(5648),u=l(74775),a=l(5937),m=l(2068),_=l(74399),g=l(63942),b=l(16073),C=l(24628),x=l(19260),f=l(56140),d=l(5388),j=l(49545),P=l(6965),O=l(49706),z=l(95127),E=l(74418),A=l(73024),t=l(94065),i=l(67294),n=l(96923);function s(){var r=(0,t.eL)(),e=r.texts;return(0,n.tZ)(t.dY,null,(0,n.tZ)(i.Fragment,null,(0,n.tZ)("div",{className:"markdown"},(0,n.tZ)("p",null,e[0].value),(0,n.tZ)("h2",{id:"when-to-use"},(0,n.tZ)("a",{"aria-hidden":"true",tabIndex:"-1",href:"#when-to-use"},(0,n.tZ)("span",{className:"icon icon-link"})),"When To Use"),(0,n.tZ)("ul",null,(0,n.tZ)("li",null,e[1].value),(0,n.tZ)("li",null,e[2].value),(0,n.tZ)("li",null,e[3].value)),(0,n.tZ)("h2",{id:"examples"},(0,n.tZ)("a",{"aria-hidden":"true",tabIndex:"-1",href:"#examples"},(0,n.tZ)("span",{className:"icon icon-link"})),"Examples")),(0,n.tZ)(d.Z,{items:[{demo:{id:"components-cascader-demo-basic"},previewerProps:{title:"Basic",filename:"components/cascader/demo/basic.tsx",jsx:`import { Cascader } from 'antd';
const options = [
  {
    value: 'zhejiang',
    label: 'Zhejiang',
...
export default App;
`,description:"<p>Cascade selection box for selecting province/city/district.</p>"}},{demo:{id:"components-cascader-demo-default-value"},previewerProps:{title:"Default value",filename:"components/cascader/demo/default-value.tsx",jsx:`import { Cascader } from 'antd';
const options = [
  {
    value: 'zhejiang',
    label: 'Zhejiang',
...
export default App;
`,description:"<p>Specifies default value by an array.</p>"}},{demo:{id:"components-cascader-demo-custom-trigger"},previewerProps:{title:"Custom trigger",filename:"components/cascader/demo/custom-trigger.tsx",jsx:`import { Cascader } from 'antd';
...
export default App;
`,description:"<p>Separate trigger button and result.</p>"}},{demo:{id:"components-cascader-demo-hover"},previewerProps:{title:"Hover",filename:"components/cascader/demo/hover.tsx",jsx:`import { Cascader } from 'antd';
const options = [
  {
    value: 'zhejiang',
    label: 'Zhejiang',
...
export default App;
`,description:"<p>Hover to expand sub menu, click to select option.</p>"}},{demo:{id:"components-cascader-demo-disabled-option"},previewerProps:{title:"Disabled option",filename:"components/cascader/demo/disabled-option.tsx",jsx:`import { Cascader } from 'antd';
const options = [
  {
    value: 'zhejiang',
    label: 'Zhejiang',
...
export default App;
`,description:"<p>Disable option by specifying the <code>disabled</code> property in <code>options</code>.</p>"}},{demo:{id:"components-cascader-demo-change-on-select"},previewerProps:{title:"Change on select",filename:"components/cascader/demo/change-on-select.tsx",jsx:`import { Cascader } from 'antd';
const options = [
  {
    value: 'zhejiang',
    label: 'Zhejiang',
...
export default App;
`,description:"<p>Allow only select parent options.</p>"}},{demo:{id:"components-cascader-demo-multiple"},previewerProps:{title:"Multiple",filename:"components/cascader/demo/multiple.tsx",jsx:`import { Cascader } from 'antd';
const options = [
  {
    label: 'Light',
    value: 'light',
...
export default App;
`,description:"<p>Select multiple options</p>"}},{demo:{id:"components-cascader-demo-showcheckedstrategy"},previewerProps:{title:"ShowCheckedStrategy",filename:"components/cascader/demo/showCheckedStrategy.tsx",jsx:`import { Cascader } from 'antd';
...
export default App;
`,description:"<p>The way show selected item in box using <code>ShowCheckedStrategy</code>.</p>"}},{demo:{id:"components-cascader-demo-size"},previewerProps:{title:"Size",filename:"components/cascader/demo/size.tsx",jsx:`import { Cascader } from 'antd';
const options = [
  {
    value: 'zhejiang',
    label: 'Zhejiang',
...
export default App;
`,description:"<p>Cascade selection box of different sizes.</p>"}},{demo:{id:"components-cascader-demo-custom-render"},previewerProps:{title:"Custom render",filename:"components/cascader/demo/custom-render.tsx",jsx:`import { Cascader } from 'antd';
const options = [
  {
    value: 'zhejiang',
    label: 'Zhejiang',
...
export default App;
`,description:"<p>For instance, add an external link after the selected value.</p>"}},{demo:{id:"components-cascader-demo-search"},previewerProps:{title:"Search",filename:"components/cascader/demo/search.tsx",jsx:`import { Cascader } from 'antd';
const options = [
  {
    value: 'zhejiang',
    label: 'Zhejiang',
...
</blockquote>`}},{demo:{id:"components-cascader-demo-lazy"},previewerProps:{title:"Load Options Lazily",filename:"components/cascader/demo/lazy.tsx",jsx:`import { Cascader } from 'antd';
import { useState } from 'react';
const optionLists = [
  {
    value: 'zhejiang',
...
</blockquote>`}},{demo:{id:"components-cascader-demo-fields-name"},previewerProps:{title:"Custom Field Names",filename:"components/cascader/demo/fields-name.tsx",jsx:`import { Cascader } from 'antd';
const options = [
  {
    code: 'zhejiang',
    name: 'Zhejiang',
...
export default App;
`,description:"<p>Custom field names.</p>"}},{demo:{id:"components-cascader-demo-suffix"},previewerProps:{debug:!0,title:"Custom Icons",filename:"components/cascader/demo/suffix.tsx",jsx:`import { SmileOutlined } from '@ant-design/icons';
...
export default App;
`,description:"<p>Customize the dropdown menu via <code>dropdownRender</code>.</p>"}},{demo:{id:"components-cascader-demo-placement"},previewerProps:{title:"Placement",filename:"components/cascader/demo/placement.tsx",jsx:`import { Cascader, Radio } from 'antd';
import { useState } from 'react';
const options = [
  {
    value: 'zhejiang',
...
export default App;
`,description:"<p>You can manually specify the position of the popup via <code>placement</code>.</p>"}},{demo:{id:"components-cascader-demo-status"},previewerProps:{title:"Status",filename:"components/cascader/demo/status.tsx",jsx:`import { Cascader, Space } from 'antd';
const App = () => (
