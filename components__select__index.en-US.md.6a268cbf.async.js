...
export default App;
`,description:"<p>Basic Usage.</p>"}},{demo:{id:"components-select-demo-search"},previewerProps:{title:"Select with search field",filename:"components/select/demo/search.tsx",jsx:`import { Select } from 'antd';
...
export default App;
`,description:"<p>Search the options while expanded.</p>"}},{demo:{id:"components-select-demo-multiple"},previewerProps:{title:"multiple selection",filename:"components/select/demo/multiple.tsx",jsx:`import { Select } from 'antd';
const options = [];
for (let i = 10; i < 36; i++) {
  options.push({
...
export default App;
`,description:"<p>Multiple selection, selecting from existing items.</p>"}},{demo:{id:"components-select-demo-size"},previewerProps:{title:"Sizes",filename:"components/select/demo/size.tsx",jsx:`import { Radio, Select } from 'antd';
...
#components-select-demo-search-box .code-box-demo .ant-select {
  margin: 0;
}`}},{demo:{id:"components-select-demo-option-label-prop"},previewerProps:{title:"Custom selection render",filename:"components/select/demo/option-label-prop.tsx",jsx:`import { Select } from 'antd';
const { Option } = Select;
const handleChange = (value) => {
  console.log(\`selected \${value}\`);
};
...
`,description:"<p>Specify the prop name of Option which will be rendered in select box.</p>",style:`.demo-option-label-item > span {
  margin-right: 6px;
}`}},{demo:{id:"components-select-demo-search-sort"},previewerProps:{title:"Search with sort",filename:"components/select/demo/search-sort.tsx",jsx:`import { Select } from 'antd';
const App = () => (
  <Select
    showSearch
    style={{
...
export default App;
`,description:"<p>Search the options with sorting.</p>"}},{demo:{id:"components-select-demo-tags"},previewerProps:{title:"Tags",filename:"components/select/demo/tags.tsx",jsx:`import { Select } from 'antd';
const options = [];
for (let i = 10; i < 36; i++) {
  options.push({
    value: i.toString(36) + i,
...
export default App;
`,description:"<p>Select with tags, transform input to tag (scroll the menu).</p>"}},{demo:{id:"components-select-demo-optgroup"},previewerProps:{title:"Option Group",filename:"components/select/demo/optgroup.tsx",jsx:`import { Select } from 'antd';
const handleChange = (value) => {
  console.log(\`selected \${value}\`);
};
const App = () => (
...
export default App;
`,description:"<p>Using <code>OptGroup</code> to group the options.</p>"}},{demo:{id:"components-select-demo-coordinate"},previewerProps:{title:"coordinate",filename:"components/select/demo/coordinate.tsx",jsx:`import { Select } from 'antd';
import { useState } from 'react';
...
<p>Using the <a href="/components/cascader">Cascader</a> component is strongly recommended instead as it is more flexible and capable.</p>`}},{demo:{id:"components-select-demo-search-box"},previewerProps:{title:"Search Box",filename:"components/select/demo/search-box.tsx",jsx:`import { Select } from 'antd';
...
export default App;
`,description:"<p>Search with remote data.</p>"}},{demo:{id:"components-select-demo-label-in-value"},previewerProps:{title:"Get value of selected item",filename:"components/select/demo/label-in-value.tsx",jsx:`import { Select } from 'antd';
const handleChange = (value) => {
...
<p>The <code>label</code> of the selected item will be packed as an object for passing to the <code>onChange</code> callback.</p>`}},{demo:{id:"components-select-demo-automatic-tokenization"},previewerProps:{title:"Automatic tokenization",filename:"components/select/demo/automatic-tokenization.tsx",jsx:`import { Select } from 'antd';
const options = [];
for (let i = 10; i < 36; i++) {
  options.push({
    value: i.toString(36) + i,
...
export default App;
`,description:"<p>Try to copy <code>Lucy,Jack</code> and paste to the input. Only available in tags and multiple mode.</p>"}},{demo:{id:"components-select-demo-select-users"},previewerProps:{title:"Search and Select Users",filename:"components/select/demo/select-users.tsx",jsx:`import { Select } from 'antd';
...
export default App;
`,description:"<p>A complete multiple select sample with remote search, debounce fetch, ajax callback order flow, and loading state.</p>"}},{demo:{id:"components-select-demo-suffix"},previewerProps:{debug:!0,title:"Suffix",filename:"components/select/demo/suffix.tsx",jsx:`import { MehOutlined, SmileOutlined } from '@ant-design/icons';
...
export default App;
`,description:"<p>Basic Usage.</p>"}},{demo:{id:"components-select-demo-custom-dropdown-menu"},previewerProps:{title:"Custom dropdown",filename:"components/select/demo/custom-dropdown-menu.tsx",jsx:`import { PlusOutlined } from '@ant-design/icons';
...
export default App;
`,description:'<p>Customize the dropdown menu via <code>dropdownRender</code>. If you want to close the dropdown after clicking the custom content, you need to control <code>open</code> prop, here is an <a href="https://codesandbox.io/s/ji-ben-shi-yong-antd-4-21-7-forked-gnp4cy?file=/demo.js">codesandbox</a>.</p>'}},{demo:{id:"components-select-demo-hide-selected"},previewerProps:{title:"Hide Already Selected",filename:"components/select/demo/hide-selected.tsx",jsx:`import { Select } from 'antd';
import { useState } from 'react';
...
export default App;
`,description:"<p>Hide already selected options in the dropdown.</p>"}},{demo:{id:"components-select-demo-bordered"},previewerProps:{title:"Bordered-less",filename:"components/select/demo/bordered.tsx",jsx:`import { Select } from 'antd';
const App = () => (
  <>
    <Select
      defaultValue="lucy"
...
export default App;
`,description:"<p>Bordered-less style component.</p>"}},{demo:{id:"components-select-demo-custom-tag-render"},previewerProps:{title:"Custom Tag Render",filename:"components/select/demo/custom-tag-render.tsx",jsx:`import { Select, Tag } from 'antd';
const options = [
  {
    value: 'gold',
  },
...
export default App;
`,description:"<p>Allows for custom rendering of tags.</p>"}},{demo:{id:"components-select-demo-responsive"},previewerProps:{title:"Responsive maxTagCount",filename:"components/select/demo/responsive.tsx",jsx:`import { Select, Space } from 'antd';
import { useState } from 'react';
const options = [];
for (let i = 10; i < 36; i++) {
...
export default App;
`,description:"<p>Auto collapse to tag with responsive case. Not recommend use in large form case since responsive calculation has a perf cost.</p>"}},{demo:{id:"components-select-demo-big-data"},previewerProps:{title:"Big Data",filename:"components/select/demo/big-data.tsx",jsx:`import { Divider, Select, Typography } from 'antd';
...
`,description:"<p>Add status to Select with <code>status</code>, which could be <code>error</code> or <code>warning</code>.</p>",style:`#components-select-demo-status .ant-select {
  margin: 0;
}`}},{demo:{id:"components-select-demo-placement"},previewerProps:{title:"Placement",filename:"components/select/demo/placement.tsx",jsx:`import { Radio, Select } from 'antd';
import { useState } from 'react';
const App = () => {
...
export default App;
`,description:"<p>You can manually specify the position of the popup via <code>placement</code>.</p>"}},{demo:{id:"components-select-demo-debug"},previewerProps:{debug:!0,title:"4.0 Debug",filename:"components/select/demo/debug.tsx",jsx:`import { Button, Input, Select } from 'antd';
const handleChange = (value) => {
  console.log(\`selected \${value}\`);
};
const App = () => (
...
#components-select-demo-debug .debug-align:after {
  ...
  bottom: 0;
  pointer-events: none;
}`}},{demo:{id:"components-select-demo-render-panel"},previewerProps:{debug:!0,title:"_InternalPanelDoNotUseOrYouWillBeFired",filename:"components/select/demo/render-panel.tsx",jsx:`import { Select, Space, Switch } from 'antd';
