...
`,description:"<p>The most basic example. The size of the floating layer depends on the contents region.</p>",style:`.ant-popover-content p {
  margin: 0;
}`}},{demo:{id:"components-popover-demo-triggertype"},previewerProps:{title:"Three ways to trigger",filename:"components/popover/demo/triggerType.tsx",jsx:`import { Button, Popover } from 'antd';
const content = (
  <div>
    <p>Content</p>
    <p>Content</p>
...
export default App;
`,description:"<p>Use <code>open</code> prop to control the display of the card.</p>"}},{demo:{id:"components-popover-demo-arrow-point-at-center"},previewerProps:{title:"Arrow pointing",filename:"components/popover/demo/arrow-point-at-center.tsx",jsx:`import { Button, Popover } from 'antd';
const content = (
  <>
    <p>Content</p>
    <p>Content</p>
...
export default App;
`,description:"<p>The arrow points to the center of the target element, which set <code>arrowPointAtCenter</code>.</p>"}},{demo:{id:"components-popover-demo-hover-with-click"},previewerProps:{title:"Hover with click popover",filename:"components/popover/demo/hover-with-click.tsx",jsx:`import { Button, Popover } from 'antd';
import { useState } from 'react';
const App = () => {
