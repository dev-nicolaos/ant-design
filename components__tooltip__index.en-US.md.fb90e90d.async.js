...
#components-tooltip-demo-placement .ant-btn {
  ...
  text-align: center;
  padding: 0;
}`}},{demo:{id:"components-tooltip-demo-arrow-point-at-center"},previewerProps:{title:"Arrow pointing at the center",filename:"components/tooltip/demo/arrow-point-at-center.tsx",jsx:`import { Button, Tooltip } from 'antd';
const App = () => (
  <>
...
export default App;
`,description:"<p>Setting <code>destroyTooltipOnHide</code> to control whether destroy dom node of tooltip when hidden.</p>"}},{demo:{id:"components-tooltip-demo-colorful"},previewerProps:{title:"Colorful Tooltip",filename:"components/tooltip/demo/colorful.tsx",jsx:`import { Button, Divider, Tooltip } from 'antd';
const colors = [
  'pink',
  'red',
  'yellow',
