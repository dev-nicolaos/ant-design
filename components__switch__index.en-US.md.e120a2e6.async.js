...
`,description:"<p>The most basic usage.</p>",style:`.code-box-demo .ant-switch {
  margin-bottom: 8px;
}`}},{demo:{id:"components-switch-demo-disabled"},previewerProps:{title:"Disabled",filename:"components/switch/demo/disabled.tsx",jsx:`import { Button, Switch } from 'antd';
