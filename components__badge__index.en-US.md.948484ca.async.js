"use strict";(self.webpackChunkantd=self.webpackChunkantd||[]).push([[4918],{96542:function(u,a,t){t.r(a);var c=t(2143),p=t(50250),_=t(59378),g=t(5648),m=t(74775),o=t(5937),h=t(2068),v=t(74399),B=t(63942),b=t(16073),Z=t(24628),f=t(19260),w=t(56140),d=t(5388),x=t(49545),C=t(6965),A=t(49706),P=t(95127),S=t(74418),E=t(73024),l=t(94065),s=t(67294),e=t(96923);function i(){var r=(0,l.eL)(),n=r.texts;return(0,e.tZ)(l.dY,null,(0,e.tZ)(s.Fragment,null,(0,e.tZ)("div",{className:"markdown"},(0,e.tZ)("p",null,n[0].value),(0,e.tZ)("h2",{id:"when-to-use"},(0,e.tZ)("a",{"aria-hidden":"true",tabIndex:"-1",href:"#when-to-use"},(0,e.tZ)("span",{className:"icon icon-link"})),"When To Use"),(0,e.tZ)("p",null,n[1].value),(0,e.tZ)("h2",{id:"examples"},(0,e.tZ)("a",{"aria-hidden":"true",tabIndex:"-1",href:"#examples"},(0,e.tZ)("span",{className:"icon icon-link"})),"Examples")),(0,e.tZ)(d.Z,{items:[{demo:{id:"components-badge-demo-basic"},previewerProps:{title:"Basic",filename:"components/badge/demo/basic.tsx",jsx:`import { ClockCircleOutlined } from '@ant-design/icons';
...
export default App;
`,description:"<p>Simplest Usage. Badge will be hidden when <code>count</code> is <code>0</code>, but we can use <code>showZero</code> to show it.</p>"}},{demo:{id:"components-badge-demo-no-wrapper"},previewerProps:{title:"Standalone",filename:"components/badge/demo/no-wrapper.tsx",jsx:`import { Badge, Space, Switch } from 'antd';
...
export default App;
`,description:"<p>Used in standalone when children is empty.</p>"}},{demo:{id:"components-badge-demo-overflow"},previewerProps:{title:"Overflow Count",filename:"components/badge/demo/overflow.tsx",jsx:`import { Avatar, Badge, Space } from 'antd';
const App = () => (
  <Space size="large">
    <Badge count={99}>
      <Avatar shape="square" size="large" />
...
export default App;
`,description:"<p>This will simply display a red badge, without a specific count. If count equals 0, it won't display the dot.</p>"}},{demo:{id:"components-badge-demo-change"},previewerProps:{title:"Dynamic",filename:"components/badge/demo/change.tsx",jsx:`import { MinusOutlined, PlusOutlined, QuestionOutlined } from '@ant-design/icons';
...
export default App;
`,description:"<p>The count will be animated as it changes.</p>"}},{demo:{id:"components-badge-demo-link"},previewerProps:{title:"Clickable",filename:"components/badge/demo/link.tsx",jsx:`import { Avatar, Badge } from 'antd';
const App = () => (
  <a href="#">
    <Badge count={5}>
      <Avatar shape="square" size="large" />
...
export default App;
`,description:"<p>The badge can be wrapped with <code>a</code> tag to make it linkable.</p>"}},{demo:{id:"components-badge-demo-offset"},previewerProps:{title:"Offset",filename:"components/badge/demo/offset.tsx",jsx:`import { Avatar, Badge } from 'antd';
const App = () => (
...
export default App;
`,description:"<p>Set size of numeral Badge.</p>"}},{demo:{id:"components-badge-demo-status"},previewerProps:{title:"Status",filename:"components/badge/demo/status.tsx",jsx:`import { Badge, Space } from 'antd';
const App = () => (
  <>
    <Space>
...
export default App;
`,description:"<p>Standalone badge with status.</p>"}},{demo:{id:"components-badge-demo-colorful"},previewerProps:{title:"Colorful Badge",filename:"components/badge/demo/colorful.tsx",jsx:`import { Badge, Divider, Space } from 'antd';
const colors = [
  'pink',
  'red',
  'yellow',
...
export default App;
`,description:"<p>We preset a series of colorful Badge styles for use in different situations. You can also set it to a hex color string for custom color.</p>"}},{demo:{id:"components-badge-demo-ribbon"},previewerProps:{title:"Ribbon",filename:"components/badge/demo/ribbon.tsx",jsx:`import { Badge, Card, Space } from 'antd';
const App = () => (
  <Space
    direction="vertical"
    size="middle"
...
export default App;
`,description:"<p>Buggy!</p>"}},{demo:{id:"components-badge-demo-mix"},previewerProps:{debug:!0,title:"Mixed usage",filename:"components/badge/demo/mix.tsx",jsx:`import { Avatar, Badge, Space } from 'antd';
const App = () => (
...
export default App;
`,description:"<p>Using <code>count/dot</code> with custom <code>stauts/color</code>.</p>"}},{demo:{id:"components-badge-demo-title"},previewerProps:{debug:!0,title:"Title",filename:"components/badge/demo/title.tsx",jsx:`import { Avatar, Badge, Space } from 'antd';
const App = () => (
  <Space size="large">
...
export default App;
`,description:"<p>The badge will display <code>title</code> when hovered over, instead of <code>count</code>.</p>"}},{demo:{id:"components-badge-demo-colorful-with-count-debug"},previewerProps:{debug:!0,title:"Colorful Badge support count Debug",filename:"components/badge/demo/colorful-with-count-debug.tsx",jsx:`import { Badge, Space } from 'antd';
const colors = [
  'pink',
  'red',
  'yellow',
