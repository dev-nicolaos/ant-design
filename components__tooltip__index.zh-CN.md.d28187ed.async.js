"use strict";(self.webpackChunkantd=self.webpackChunkantd||[]).push([[3451],{63729:function(r,o,l){l.r(o);var p=l(2143),s=l(50250),m=l(59378),v=l(5648),Z=l(74775),u=l(5937),c=l(2068),h=l(74399),T=l(63942),B=l(16073),x=l(24628),E=l(19260),g=l(56140),a=l(5388),P=l(49545),f=l(6965),D=l(49706),A=l(95127),O=l(74418),C=l(73024),e=l(94065),i=l(67294),t=l(96923);function d(){var _=(0,e.eL)(),n=_.texts;return(0,t.tZ)(e.dY,null,(0,t.tZ)(i.Fragment,null,(0,t.tZ)("div",{className:"markdown"},(0,t.tZ)("p",null,n[0].value),(0,t.tZ)("h2",{id:"\u4F55\u65F6\u4F7F\u7528"},(0,t.tZ)("a",{"aria-hidden":"true",tabIndex:"-1",href:"#\u4F55\u65F6\u4F7F\u7528"},(0,t.tZ)("span",{className:"icon icon-link"})),"\u4F55\u65F6\u4F7F\u7528"),(0,t.tZ)("p",null,n[1].value),(0,t.tZ)("p",null,n[2].value,(0,t.tZ)("code",null,n[3].value),n[4].value,(0,t.tZ)("code",null,n[5].value),n[6].value),(0,t.tZ)("h2",{id:"\u4EE3\u7801\u6F14\u793A"},(0,t.tZ)("a",{"aria-hidden":"true",tabIndex:"-1",href:"#\u4EE3\u7801\u6F14\u793A"},(0,t.tZ)("span",{className:"icon icon-link"})),"\u4EE3\u7801\u6F14\u793A")),(0,t.tZ)(a.Z,{items:[{demo:{id:"components-tooltip-demo-basic"},previewerProps:{title:"\u57FA\u672C",filename:"components/tooltip/demo/basic.tsx",jsx:`import { Tooltip } from 'antd';
const App = () => (
...
#components-tooltip-demo-placement .ant-btn {
  ...
  text-align: center;
  padding: 0;
}`}},{demo:{id:"components-tooltip-demo-arrow-point-at-center"},previewerProps:{title:"\u7BAD\u5934\u6307\u5411",filename:"components/tooltip/demo/arrow-point-at-center.tsx",jsx:`import { Button, Tooltip } from 'antd';
const App = () => (
  <>
...
export default App;
`,description:"<p>\u8BBE\u7F6E\u4E86 <code>arrowPointAtCenter</code> \u540E\uFF0C\u7BAD\u5934\u5C06\u6307\u5411\u76EE\u6807\u5143\u7D20\u7684\u4E2D\u5FC3\u3002</p>"}},{demo:{id:"components-tooltip-demo-auto-adjust-overflow"},previewerProps:{debug:!0,title:"\u81EA\u52A8\u8C03\u6574\u4F4D\u7F6E",filename:"components/tooltip/demo/auto-adjust-overflow.tsx",jsx:`import { Button, Tooltip } from 'antd';
const wrapStyles = {
  overflow: 'hidden',
  position: 'relative',
  padding: '24px',
...
export default App;
`,description:"<p>\u901A\u8FC7 <code>destroyTooltipOnHide</code> \u63A7\u5236\u63D0\u793A\u5173\u95ED\u65F6\u662F\u5426\u9500\u6BC1 dom \u8282\u70B9\u3002</p>"}},{demo:{id:"components-tooltip-demo-colorful"},previewerProps:{title:"\u591A\u5F69\u6587\u5B57\u63D0\u793A",filename:"components/tooltip/demo/colorful.tsx",jsx:`import { Button, Divider, Tooltip } from 'antd';
const colors = [
  'pink',
  'red',
  'yellow',
...
`,description:"<p>\u6211\u4EEC\u6DFB\u52A0\u4E86\u591A\u79CD\u9884\u8BBE\u8272\u5F69\u7684\u6587\u5B57\u63D0\u793A\u6837\u5F0F\uFF0C\u7528\u4F5C\u4E0D\u540C\u573A\u666F\u4F7F\u7528\u3002</p>",style:`.ant-tag {
  margin-bottom: 8px;
}`}},{demo:{id:"components-tooltip-demo-render-panel"},previewerProps:{debug:!0,title:"_InternalPanelDoNotUseOrYouWillBeFired",filename:"components/tooltip/demo/render-panel.tsx",jsx:`import { Tooltip } from 'antd';
