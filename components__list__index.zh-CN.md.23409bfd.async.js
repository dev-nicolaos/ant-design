...
<p>\u53EF\u901A\u8FC7\u8BBE\u7F6E <code>header</code> \u548C <code>footer</code>\uFF0C\u6765\u81EA\u5B9A\u4E49\u5217\u8868\u5934\u90E8\u548C\u5C3E\u90E8\u3002</p>`}},{demo:{id:"components-list-demo-basic"},previewerProps:{title:"\u57FA\u7840\u5217\u8868",filename:"components/list/demo/basic.tsx",jsx:`import { Avatar, List } from 'antd';
const data = [
  {
...
export default App;
`,description:"<p>\u57FA\u7840\u5217\u8868\u3002</p>"}},{demo:{id:"components-list-demo-loadmore"},previewerProps:{title:"\u52A0\u8F7D\u66F4\u591A",filename:"components/list/demo/loadmore.tsx",jsx:`import { Avatar, Button, List, Skeleton } from 'antd';
...
`,description:"<p>\u53EF\u901A\u8FC7 <code>loadMore</code> \u5C5E\u6027\u5B9E\u73B0\u52A0\u8F7D\u66F4\u591A\u529F\u80FD\u3002</p>",style:`.demo-loadmore-list {
  min-height: 350px;
}`}},{demo:{id:"components-list-demo-vertical"},previewerProps:{title:"\u7AD6\u6392\u5217\u8868\u6837\u5F0F",filename:"components/list/demo/vertical.tsx",jsx:`import { Avatar, List, Space } from 'antd';
...
export default App;
`,description:"<p>\u901A\u8FC7\u8BBE\u7F6E <code>itemLayout</code> \u5C5E\u6027\u4E3A <code>vertical</code> \u53EF\u5B9E\u73B0\u7AD6\u6392\u5217\u8868\u6837\u5F0F\u3002</p>"}},{demo:{id:"components-list-demo-grid"},previewerProps:{title:"\u6805\u683C\u5217\u8868",filename:"components/list/demo/grid.tsx",jsx:`import { Card, List } from 'antd';
const data = [
  {
    title: 'Title 1',
  },
...
export default App;
`,description:"<p>\u53EF\u4EE5\u901A\u8FC7\u8BBE\u7F6E <code>List</code> \u7684 <code>grid</code> \u5C5E\u6027\u6765\u5B9E\u73B0\u6805\u683C\u5217\u8868\uFF0C<code>column</code> \u53EF\u8BBE\u7F6E\u671F\u671B\u663E\u793A\u7684\u5217\u6570\u3002</p>"}},{demo:{id:"components-list-demo-grid-test"},previewerProps:{debug:!0,title:"\u6D4B\u8BD5\u6805\u683C\u5217\u8868",filename:"components/list/demo/grid-test.tsx",jsx:`import { Card, List } from 'antd';
const data = [
  {
    title: 'Title 1',
  },
...
export default App;
`,description:"<p>List <code>grid</code> \u5728\u5404\u79CD\u60C5\u51B5\u4E0B\u7684\u6837\u5F0F\u8868\u73B0\uFF0C\u5982 Fragment \u548C\u5C01\u88C5\u4E86 List.Item.</p>"}},{demo:{id:"components-list-demo-responsive"},previewerProps:{title:"\u54CD\u5E94\u5F0F\u7684\u6805\u683C\u5217\u8868",filename:"components/list/demo/responsive.tsx",jsx:`import { Card, List } from 'antd';
const data = [
  {
    title: 'Title 1',
  },
...
export default App;
`,description:'<p>\u54CD\u5E94\u5F0F\u7684\u6805\u683C\u5217\u8868\u3002\u5C3A\u5BF8\u4E0E <a href="/components/grid/#col">Layout Grid</a> \u4FDD\u6301\u4E00\u81F4\u3002</p>'}},{demo:{id:"components-list-demo-infinite-load"},previewerProps:{title:"\u6EDA\u52A8\u52A0\u8F7D",filename:"components/list/demo/infinite-load.tsx",jsx:`import { Avatar, Divider, List, Skeleton } from 'antd';
import { useEffect, useState } from 'react';
...
export default App;
`,description:'<p>\u7ED3\u5408 <a href="https://github.com/ankeetmaini/react-infinite-scroll-component">react-infinite-scroll-component</a> \u5B9E\u73B0\u6EDA\u52A8\u81EA\u52A8\u52A0\u8F7D\u5217\u8868\u3002</p>'}},{demo:{id:"components-list-demo-virtual-list"},previewerProps:{title:"\u6EDA\u52A8\u52A0\u8F7D\u65E0\u9650\u957F\u5217\u8868",filename:"components/list/demo/virtual-list.tsx",jsx:`import { Avatar, List, message } from 'antd';
